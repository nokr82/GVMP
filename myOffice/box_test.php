...
include_once('./OrganizationChartInfo_test.php');
?>
...
if (isset($_GET['mb_id']) && !isset($_GET['boxCheck'])) {
    sel_teamCount($teamCountUser, $_GET['mb_id'], '');//문제!!!

    $check = 0;

    $check = count($mb_info_1T) + count($mb_info_2T);
...
if ($rowTopID['sponsorID'] == "00000000") {
    ...
    $TopID = "/myOffice/box_1_test.php?mb_id=" . $rowTopID['sponsorID'] . "&boxCheck=true";
}
?>
<body>
...
<section class="boxSection clearfix">
    ...
    <div class="boxSearBox">
        <a href="/myOffice/box_1_test.php" class="boxBtn boxTree_btn boxTree_btn0-1">
        ...
        <?php
        if ($lower1T_ID != "") {
            echo "<a href=\"/myOffice/box_1_test.php?mb_id={$lower1T_ID}&boxCheck=true#\" class=\"boxTree_btn boxTree_btn2\">1팀 최하단</a>";
        } else {
            echo "<a href=\"#\" class=\"boxTree_btn boxTree_btn2\">1팀 최하단</a>";
        }

        if ($lower2T_ID != "") {
            echo "<a href=\"/myOffice/box_1_test.php?mb_id={$lower2T_ID}&boxCheck=true#\" class=\"boxTree_btn boxTree_btn3\">2팀 최하단</a>";
        } else {
...
<div id="spot" style="visibility: hidden;">
    ...
    $member['VMR'] = number_format($member['VMR']);
...
<script type="text/javascript">
    ...
    function modify_check(mb_id) {
        ...
        if (rank == '5 STAR' || rank == 'AMBASSADOR' || rank == 'Crown AMBASSADOR' || rank == 'Double AMBASSADOR' || rank == 'Royal Crown AMBASSADOR' || rank == 'Triple AMBASSADOR'
            || admin_mb_id == "00003656" || admin_mb_id == "00003696" || admin_mb_id == "00000182" || admin_mb_id == "00003710") {
    ...
    function selectView(id) {
        location.href = "/myOffice/box_1_test.php?mb_id=" + id + "&boxCheck=true";
    }
        ...
        if ($("#nameNick option:selected").val() == "아이디") {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (result == "true") {
                        location.href = '/myOffice/box_test.php?mb_id=' + $('#searchInput').val();
                    } else {
    ...
    function searchSelect(id) {
        window.location.href = '/myOffice/box_1_test.php?mb_id=' + id;
    }
