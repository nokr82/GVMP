...
?>
<div id="signUp">
<form name="signupForm" action="myoffice_signUp_Update.php" method="post">
                ...
                <div class="sign_sponser firstsopnser">
                    ...
                    <div class="sign_sponser_content">
                        <ul class="clearfix">
                            <li class="clearfix">
                                <h4>이름 :</h4>
                                <input type="text" name="user_name1" id="user_name1" required>
                            </li>
                            <li class="clearfix">
                                <h4>회원번호 :</h4>
                                <input type="text" name="user_num1" id="user_num1" maxlength="8" onkeydown="onlyNumber(this)" class="usernum" required>
                            </li>
                            <li class="clearfix">
                                <h4>팀 :</h4>
                                <div>
