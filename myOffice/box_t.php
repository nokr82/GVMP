...
$modi_auth = false;
if ($member['accountRank'] == '5 STAR' || $member['accountRank'] == 'AMBASSADOR' || $member['accountRank'] == 'Crown AMBASSADOR' || $member['accountRank'] == 'Double AMBASSADOR' || $member['accountRank'] == 'Royal Crown AMBASSADOR' || $member['accountRank'] == 'Triple AMBASSADOR' || $member['mb_id'] == "00003656" || $member['mb_id'] == "00000182" || $member['mb_id'] == "00000163" || $member['mb_id'] == "00031544" || $member['mb_id'] == "00003696" || $member['mb_id'] == "00003710" || $member['mb_id'] == "00003686" || $member['mb_id'] == "00003943" || $member['mb_id'] == "00003571" || $member['mb_id'] == "00003697" || $member['mb_id'] == "00003879"  || $member['mb_id'] == "00003660"|| $member['mb_id'] == "00003880") {
    $modi_auth = true;
}
?>
...
if ($rowTopID['sponsorID'] == "00000000") {
    ...
    $TopID = "/myOffice/box_t.php?mb_id=" . $rowTopID['sponsorID'] . "&boxCheck=true";
}
?>
<body>
...
<section class="boxSection clearfix">
    ...
    <div class="boxSearBox">
        <a href="/myOffice/box_t.php" class="boxBtn boxTree_btn boxTree_btn0-1">
        ...
        <?php
        if ($lower1T_ID != "") {
            echo "<a href=\"/myOffice/box_t.php?mb_id={$lower1T_ID}&boxCheck=true#\" class=\"boxTree_btn boxTree_btn2\">1팀 최하단</a>";
        } else {
            echo "<a href=\"#\" class=\"boxTree_btn boxTree_btn2\">1팀 최하단</a>";
        }

        if ($lower2T_ID != "") {
            echo "<a href=\"/myOffice/box_t.php?mb_id={$lower2T_ID}&boxCheck=true#\" class=\"boxTree_btn boxTree_btn3\">2팀 최하단</a>";
        } else {
        ...
        <div class="boxContent" style="left:-13%;" id="draggable">
            ...
            <div class="boxDepth1">
                ...
                if ($memberInfo['1촌']['1번']['존재유무'] == true) {
                    ...
                    echo "<div class=\"boxLevel1 boxRight\" >"
                        ...
                        . "<br /></p>";
                    if ($memberInfo['1촌']['1번']['직급'] == "VM" || $memberInfo['1촌']['1번']['직급'] == "MASTER" || $memberInfo['1촌']['1번']['직급'] == "Double MASTER" || $memberInfo['1촌']['1번']['직급'] == "Triple MASTER") {
                        if ($modi_auth) {
                ...
                if ($memberInfo['1촌']['2번']['존재유무'] == true) {
                    ...
                    if ($memberInfo['1촌']['2번']['직급'] == "VM" || $memberInfo['1촌']['2번']['직급'] == "MASTER" || $memberInfo['1촌']['2번']['직급'] == "Double MASTER" || $memberInfo['1촌']['2번']['직급'] == "Triple MASTER") {
                        if ($modi_auth) {
            ...
            <div class="boxDepth2">
                ...
                if ($memberInfo['2촌']['1번']['존재유무'] == true) {
                    ...
                    if ($memberInfo['2촌']['1번']['직급'] == "VM" || $memberInfo['2촌']['1번']['직급'] == "MASTER" || $memberInfo['2촌']['1번']['직급'] == "Double MASTER" || $memberInfo['2촌']['1번']['직급'] == "Triple MASTER") {
                        if ($modi_auth) {
                ...
                if ($memberInfo['2촌']['2번']['존재유무'] == true) {
                    ...
                    if ($memberInfo['2촌']['2번']['직급'] == "VM" || $memberInfo['2촌']['2번']['직급'] == "MASTER" || $memberInfo['2촌']['2번']['직급'] == "Double MASTER" || $memberInfo['2촌']['2번']['직급'] == "Triple MASTER") {
                        if ($modi_auth) {
                ...
                if ($memberInfo['2촌']['3번']['존재유무'] == true) {
                   ...
                   <a style=\"background-color: {$memberInfo['2촌']['3번']['색상코드']};\" onclick=\"selectView(this.id)\" href=\"#\" id=\"{$memberInfo['2촌']['3번']['아이디']}\">
                    ...
                    if ($memberInfo['2촌']['3번']['직급'] == "VM" || $memberInfo['2촌']['3번']['직급'] == "MASTER" || $memberInfo['2촌']['3번']['직급'] == "Double MASTER" || $memberInfo['2촌']['3번']['직급'] == "Triple MASTER") {
                        if ($modi_auth) {
                ...
                if ($memberInfo['2촌']['4번']['존재유무'] == true) {
                    ...
                    if ($memberInfo['2촌']['4번']['직급'] == "VM" || $memberInfo['2촌']['4번']['직급'] == "MASTER" || $memberInfo['2촌']['4번']['직급'] == "Double MASTER" || $memberInfo['2촌']['4번']['직급'] == "Triple MASTER") {
                        if ($modi_auth) {
            ...
            <div class="boxDepth3">
                ...
                if ($memberInfo['3촌']['1번']['존재유무'] == true) {
                   ...
                   <a style=\"background-color: {$memberInfo['3촌']['1번']['색상코드']};\" onclick=\"selectView(this.id)\" href=\"#\" id=\"{$memberInfo['3촌']['1번']['아이디']}\">
                    ...
                    if ($memberInfo['3촌']['1번']['직급'] == "VM" || $memberInfo['3촌']['1번']['직급'] == "MASTER" || $memberInfo['3촌']['1번']['직급'] == "Double MASTER" || $memberInfo['3촌']['1번']['직급'] == "Triple MASTER") {
                        if ($modi_auth) {
                ...
                if ($memberInfo['3촌']['2번']['존재유무'] == true) {
                    ...
                    if ($memberInfo['3촌']['2번']['직급'] == "VM" || $memberInfo['3촌']['2번']['직급'] == "MASTER" || $memberInfo['3촌']['2번']['직급'] == "Double MASTER" || $memberInfo['3촌']['2번']['직급'] == "Triple MASTER") {
                        if ($modi_auth) {
                ...
                if ($memberInfo['3촌']['3번']['존재유무'] == true) {
                   ...
                   <a style=\"background-color: {$memberInfo['3촌']['3번']['색상코드']};\" onclick=\"selectView(this.id)\" href=\"#\" id=\"{$memberInfo['3촌']['3번']['아이디']}\">
                    ...
                    if ($memberInfo['3촌']['3번']['직급'] == "VM" || $memberInfo['3촌']['3번']['직급'] == "MASTER" || $memberInfo['3촌']['3번']['직급'] == "Double MASTER" || $memberInfo['3촌']['3번']['직급'] == "Triple MASTER") {
                        if ($modi_auth) {
                ...
                if ($memberInfo['3촌']['4번']['존재유무'] == true) {
                    ...
                    if ($memberInfo['3촌']['4번']['직급'] == "VM" || $memberInfo['3촌']['4번']['직급'] == "MASTER" || $memberInfo['3촌']['4번']['직급'] == "Double MASTER" || $memberInfo['3촌']['4번']['직급'] == "Triple MASTER") {
                        if ($modi_auth) {
                ...
                if ($memberInfo['3촌']['5번']['존재유무'] == true) {
                   ...
                   <a style=\"background-color: {$memberInfo['3촌']['5번']['색상코드']};\" onclick=\"selectView(this.id)\" href=\"#\" id=\"{$memberInfo['3촌']['5번']['아이디']}\">
                    ...
                    if ($memberInfo['3촌']['5번']['직급'] == "VM" || $memberInfo['3촌']['5번']['직급'] == "MASTER" || $memberInfo['3촌']['5번']['직급'] == "Double MASTER" || $memberInfo['3촌']['5번']['직급'] == "Triple MASTER") {
                        if ($modi_auth) {
                ...
                if ($memberInfo['3촌']['6번']['존재유무'] == true) {
                    ...
                    if ($memberInfo['3촌']['6번']['직급'] == "VM" || $memberInfo['3촌']['6번']['직급'] == "MASTER" || $memberInfo['3촌']['6번']['직급'] == "Double MASTER" || $memberInfo['3촌']['6번']['직급'] == "Triple MASTER") {
                        if ($modi_auth) {
                ...
                if ($memberInfo['3촌']['7번']['존재유무'] == true) {
                   ...
                   <a style=\"background-color: {$memberInfo['3촌']['7번']['색상코드']};\" onclick=\"selectView(this.id)\" href=\"#\" id=\"{$memberInfo['3촌']['7번']['아이디']}\">
                    ...
                    if ($memberInfo['3촌']['7번']['직급'] == "VM" || $memberInfo['3촌']['7번']['직급'] == "MASTER" || $memberInfo['3촌']['7번']['직급'] == "Double MASTER" || $memberInfo['3촌']['7번']['직급'] == "Triple MASTER") {
                        if ($modi_auth) {
                ...
                if ($memberInfo['3촌']['8번']['존재유무'] == true) {
                    ...
                    if ($memberInfo['3촌']['8번']['직급'] == "VM" || $memberInfo['3촌']['8번']['직급'] == "MASTER" || $memberInfo['3촌']['8번']['직급'] == "Double MASTER" || $memberInfo['3촌']['8번']['직급'] == "Triple MASTER") {
                        if ($modi_auth) {
            ...
            <div class="boxDepth4">
                ...
                if ($memberInfo['4촌']['1번']['존재유무'] == true) {
                   ...
                   <a style=\"background-color: {$memberInfo['4촌']['1번']['색상코드']};\" onclick=\"selectView(this.id)\" href=\"#\" id=\"{$memberInfo['4촌']['1번']['아이디']}\">
                    ...
                    if ($memberInfo['4촌']['1번']['직급'] == "VM" || $memberInfo['4촌']['1번']['직급'] == "MASTER" || $memberInfo['4촌']['1번']['직급'] == "Double MASTER" || $memberInfo['4촌']['1번']['직급'] == "Triple MASTER") {
                        if ($modi_auth) {
                ...
                if ($memberInfo['4촌']['2번']['존재유무'] == true) {
                    ...
                    if ($memberInfo['4촌']['2번']['직급'] == "VM" || $memberInfo['4촌']['2번']['직급'] == "MASTER" || $memberInfo['4촌']['2번']['직급'] == "Double MASTER" || $memberInfo['4촌']['2번']['직급'] == "Triple MASTER") {
                        if ($modi_auth) {
                ...
                if ($memberInfo['4촌']['3번']['존재유무'] == true) {
                   ...
                   <a style=\"background-color: {$memberInfo['4촌']['3번']['색상코드']};\" onclick=\"selectView(this.id)\" href=\"#\" id=\"{$memberInfo['4촌']['3번']['아이디']}\">
                    ...
                    if ($memberInfo['4촌']['3번']['직급'] == "VM" || $memberInfo['4촌']['3번']['직급'] == "MASTER" || $memberInfo['4촌']['3번']['직급'] == "Double MASTER" || $memberInfo['4촌']['3번']['직급'] == "Triple MASTER") {
                        if ($modi_auth) {
                ...
                if ($memberInfo['4촌']['4번']['존재유무'] == true) {
                    ...
                    if ($memberInfo['4촌']['4번']['직급'] == "VM" || $memberInfo['4촌']['4번']['직급'] == "MASTER" || $memberInfo['4촌']['4번']['직급'] == "Double MASTER" || $memberInfo['4촌']['4번']['직급'] == "Triple MASTER") {
                        if ($modi_auth) {
                ...
                if ($memberInfo['4촌']['5번']['존재유무'] == true) {
                   ...
                   <a style=\"background-color: {$memberInfo['4촌']['5번']['색상코드']};\" onclick=\"selectView(this.id)\" href=\"#\" id=\"{$memberInfo['4촌']['5번']['아이디']}\">
                    ...
                    if ($memberInfo['4촌']['5번']['직급'] == "VM" || $memberInfo['4촌']['5번']['직급'] == "MASTER" || $memberInfo['4촌']['5번']['직급'] == "Double MASTER" || $memberInfo['4촌']['5번']['직급'] == "Triple MASTER") {
                        if ($modi_auth) {
                ...
                if ($memberInfo['4촌']['6번']['존재유무'] == true) {
                    ...
                    if ($memberInfo['4촌']['6번']['직급'] == "VM" || $memberInfo['4촌']['6번']['직급'] == "MASTER" || $memberInfo['4촌']['6번']['직급'] == "Double MASTER" || $memberInfo['4촌']['6번']['직급'] == "Triple MASTER") {
                        if ($modi_auth) {
                ...
                if ($memberInfo['4촌']['7번']['존재유무'] == true) {
                   ...
                   <a style=\"background-color: {$memberInfo['4촌']['7번']['색상코드']};\" onclick=\"selectView(this.id)\" href=\"#\" id=\"{$memberInfo['4촌']['7번']['아이디']}\">
                    ...
                    if ($memberInfo['4촌']['7번']['직급'] == "VM" || $memberInfo['4촌']['7번']['직급'] == "MASTER" || $memberInfo['4촌']['7번']['직급'] == "Double MASTER" || $memberInfo['4촌']['7번']['직급'] == "Triple MASTER") {
                        if ($modi_auth) {
                ...
                if ($memberInfo['4촌']['8번']['존재유무'] == true) {
                    ...
                    if ($memberInfo['4촌']['8번']['직급'] == "VM" || $memberInfo['4촌']['8번']['직급'] == "MASTER" || $memberInfo['4촌']['8번']['직급'] == "Double MASTER" || $memberInfo['4촌']['8번']['직급'] == "Triple MASTER") {
                        if ($modi_auth) {
                ...
                if ($memberInfo['4촌']['9번']['존재유무'] == true) {
                   ...
                   <a style=\"background-color: {$memberInfo['4촌']['9번']['색상코드']};\" onclick=\"selectView(this.id)\" href=\"#\" id=\"{$memberInfo['4촌']['9번']['아이디']}\">
                    ...
                    if ($memberInfo['4촌']['9번']['직급'] == "VM" || $memberInfo['4촌']['9번']['직급'] == "MASTER" || $memberInfo['4촌']['9번']['직급'] == "Double MASTER" || $memberInfo['4촌']['9번']['직급'] == "Triple MASTER") {
                        if ($modi_auth) {
                ...
                if ($memberInfo['4촌']['10번']['존재유무'] == true) {
                    ...
                    if ($memberInfo['4촌']['10번']['직급'] == "VM" || $memberInfo['4촌']['10번']['직급'] == "MASTER" || $memberInfo['4촌']['10번']['직급'] == "Double MASTER" || $memberInfo['4촌']['10번']['직급'] == "Triple MASTER") {
                        if ($modi_auth) {
                ...
                if ($memberInfo['4촌']['11번']['존재유무'] == true) {
                   ...
                   <a style=\"background-color: {$memberInfo['4촌']['11번']['색상코드']};\" onclick=\"selectView(this.id)\" href=\"#\" id=\"{$memberInfo['4촌']['11번']['아이디']}\">
                    ...
                    if ($memberInfo['4촌']['11번']['직급'] == "VM" || $memberInfo['4촌']['11번']['직급'] == "MASTER" || $memberInfo['4촌']['11번']['직급'] == "Double MASTER" || $memberInfo['4촌']['11번']['직급'] == "Triple MASTER") {
                        if ($modi_auth) {
                ...
                if ($memberInfo['4촌']['12번']['존재유무'] == true) {
                    ...
                    if ($memberInfo['4촌']['12번']['직급'] == "VM" || $memberInfo['4촌']['12번']['직급'] == "MASTER" || $memberInfo['4촌']['12번']['직급'] == "Double MASTER" || $memberInfo['4촌']['12번']['직급'] == "Triple MASTER") {
                        if ($modi_auth) {
                ...
                if ($memberInfo['4촌']['13번']['존재유무'] == true) {
                   ...
                   <a style=\"background-color: {$memberInfo['4촌']['13번']['색상코드']};\" onclick=\"selectView(this.id)\" href=\"#\" id=\"{$memberInfo['4촌']['13번']['아이디']}\">
                    ...
                    if ($memberInfo['4촌']['13번']['직급'] == "VM" || $memberInfo['4촌']['13번']['직급'] == "MASTER" || $memberInfo['4촌']['13번']['직급'] == "Double MASTER" || $memberInfo['4촌']['13번']['직급'] == "Triple MASTER") {
                        if ($modi_auth) {
                ...
                if ($memberInfo['4촌']['14번']['존재유무'] == true) {
                    ...
                    if ($memberInfo['4촌']['14번']['직급'] == "VM" || $memberInfo['4촌']['14번']['직급'] == "MASTER" || $memberInfo['4촌']['14번']['직급'] == "Double MASTER" || $memberInfo['4촌']['14번']['직급'] == "Triple MASTER") {
                        if ($modi_auth) {
                ...
                if ($memberInfo['4촌']['15번']['존재유무'] == true) {
                   ...
                   <a style=\"background-color: {$memberInfo['4촌']['15번']['색상코드']};\" onclick=\"selectView(this.id)\" href=\"#\" id=\"{$memberInfo['4촌']['15번']['아이디']}\">
                    ...
                    if ($memberInfo['4촌']['15번']['직급'] == "VM" || $memberInfo['4촌']['15번']['직급'] == "MASTER" || $memberInfo['4촌']['15번']['직급'] == "Double MASTER" || $memberInfo['4촌']['15번']['직급'] == "Triple MASTER") {
                        if ($modi_auth) {
                ...
                if ($memberInfo['4촌']['16번']['존재유무'] == true) {
                    ...
                    if ($memberInfo['4촌']['16번']['직급'] == "VM" || $memberInfo['4촌']['16번']['직급'] == "MASTER" || $memberInfo['4촌']['16번']['직급'] == "Double MASTER" || $memberInfo['4촌']['16번']['직급'] == "Triple MASTER") {
                        if ($modi_auth) {
...
//                        $(".modi_img").style.display = "block";
        ...
        //현재페이지가 초기페이지와같으면
        var uri = '<?=$request_uri?>';
        if (result != 1 && uri == '/myOffice/box_t.php') {
            start_load();
        }
    ...
    function modify_check(mb_id) {
        ...
        if (rank == '5 STAR' || rank == 'AMBASSADOR' || rank == 'Crown AMBASSADOR' || rank == 'Double AMBASSADOR' || rank == 'Royal Crown AMBASSADOR' || rank == 'Triple AMBASSADOR'
            || admin_mb_id == "00003656" || admin_mb_id == "00003696" || admin_mb_id == "00000182" || admin_mb_id == "00003710" || admin_mb_id == "00031544" || admin_mb_id == "00003686" || admin_mb_id == "00003943" || admin_mb_id == "00003571" || admin_mb_id == "00003697"|| admin_mb_id == "00003879"   || admin_mb_id == "00003660"|| admin_mb_id == "00003880" ) {
    ...
    function selectView(id) {
        location.href = "/myOffice/box_t.php?mb_id=" + id + "&boxCheck=true";
    }
    ...
    function searchClick() {
        if (result != 1 &&  '<?=$request_uri?>' == '/myOffice/box_t.php') {
            loading();
        ...
        if ($("#nameNick option:selected").val() == "아이디") {
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result == "true") {
                        location.href = '/myOffice/box_t.php?mb_id=' + $('#searchInput').val()+'&boxCheck=true';
                    } else {
...
//                       submenu.slideDown();
    ...
    function searchSelect(id) {
        window.location.href = '/myOffice/box_t.php?mb_id=' + id+'&boxCheck=true';
    }
