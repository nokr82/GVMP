...
$configR = mysql_fetch_array(mysql_query("select * from config where config = 'simpleJoin'"));
$rankOrR1 = mysql_fetch_array(mysql_query("select * from rankOrderBy where rankAccount = '{$configR["value"]}'"));
...
<head>
    ...
    <title>간편회원가입</title>
    <link rel="stylesheet" href="http://gvmp.company/theme/everyday/css/mobile_shop.css">
            ...
            <li class="join_step wow fadeInUp">
                ...
                <?php
                    if( $member["simpleRenewal"] == "YES" || $rankOrR3["orderNum"] >= $rankOrR2["orderNum"] ) {
                        ...
                        ?> <a href="#none" class="btn renewal_btn" onclick="">
                                <i><img src="img/gear.png" alt="결제 아이콘"></i>권한 없음
                            </a> <?php
                    }
                ?>
        ...
        <div class="join_form">
                ...
                <form id="form_submit">
                    ...
                    <ul>
                        ...
                        <li class="wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <input type="text" name="user_p_number" id="user_p_number" onkeyup="onlyNumber(this)"
                                   tabindex="2">
                        </li>
                        <li class="wow fadeInUp recomm_name_box" data-wow-delay="0.4s">
                            <label for="recommender_name">추천인 이름</label>
                            <input type="text" name="recommender_name" id="recommender_name"
                                   placeholder="확인 후 자동으로 입력됩니다" readonly>
                        </li>
                        <li class="wow fadeInUp" data-wow-delay="0.5s">
                            <label for="recommender_number">추천인 회원번호</label>
                            <input type="text" name="recommender_number" id="recommender_number"
                                   onkeyup="onlyNumber(this)" tabindex="3">
                            <a href="#none" class="number_check_btn"
                               onclick="recommCheck($('#recommender_number').val())" tabindex="4">확인</a>
                        </li>
                        <li class="wow fadeInUp sponsor_name_box" data-wow-delay="0.6s">
                            <label for="sponsor_name">후원인 이름</label>
                            <input type="text" name="sponsor_name" id="sponsor_name" placeholder="확인 후 자동으로 입력됩니다"
                                   readonly>
                        </li>
                        <li class="wow fadeInUp" data-wow-delay="0.7s">
                            <label for="sponsor_number">후원인 회원번호</label>
                            <input type="text" name="sponsor_number" id="sponsor_number" onkeyup="onlyNumber(this)"
                                   tabindex="5">
                        </li>
                        <li class="wow fadeInUp" data-wow-delay="0.8s">
                            ...
                            <a href="#none" class="number_check_btn" onclick="teamCheckFunc($('#sponsor_number').val())"
                               tabindex="6">확인</a>
                        </li>
                    </ul>
                </form>
            ...
            <?php
                if( $member["simpleJoin"] == "YES" || $rankOrR1["orderNum"] >= $rankOrR2["orderNum"] ) {
                    ?> <a href="#none" class="btn submit_btn" onclick="submitCheck()">회원가입 완료</a> <?php
                } else {
                    ?> <a href="#none" class="btn submit_btn" onclick="">권한 없음</a> <?php
                }
            ?>
                ...
                <div class="pay_container">
                    ...
                    <ul>
                        ...
                        <li class="vmc_point">
                            ...
                            <input type='text' name='VMCpoint' id='VMCpoint' onkeyup="payCheck(this)" value="0"
                                   onfocus="this.select()"/><label>원</label>
                        </li>
                        <li class="my_vmc_point">
                            <strong>보유 VMC :</strong>
                            <em><b class="my_point"
                                   id="my_point_vmc"><?php echo number_format($g5_memberRow["VMC"]); ?></b>원</em>
                        </li>
                        <li class="vmp_point">
                            <label for="VMPpoint">VMP</label>
                            <input type='text' name='VMPpoint' id='VMPpoint' onkeyup="payCheck(this)" value="0"
                                   onfocus="this.select()"/><label>원</label>
                        </li>
                        <li class="my_vmp_point">
                            <strong>보유 VMP :</strong>
                            <em><b class="my_point"
                                   id="my_point_vmp"><?php echo number_format($g5_memberRow["VMP"]); ?></b>원</em>
                        </li>
                        <li class="money_box">
        ...
        <div class="renewal_pop">
            <div class="renewal_wrap">
                <div class="search_box">
                    ...
                    <input type="text" id="renewal_id" name="renewal_id" value="" placeholder="ex) 00003571 "
                           minlength="8" maxlength="8" onkeyup="onlyIdNumber(this)">
