...
header('Location: /myOffice/index_start.php');exit();
    ...
    <div class="main_content">
        ...
        <ul class="join_content clearfix">
            <li class="join_step wow fadeInUp">
                ...
                <?php
                //간편리뉴얼
//                    if( $member["simpleRenewal"] == "YES" ) { // $rankOrR3["orderNum"] >= $rankOrR2["orderNum"] . 잠시 빼놓음. 이정현. 특정 직급이상 패스되는거 일시중단
                    if( false ) {
                        ?> 
