...
function selectFunc($selectID, $checkCount) {
    ...
    if( $row3['1T_name'] != null && $row3['1T_name'] != "null" ) {
        ...
        $memberInfo[$a . '촌'][$n1 . '번']['색상코드'] = memberColor($row4['accountRank']);//수정부분
        $memberInfo[$a . '촌'][$n1 . '번']['이미지경로'] = imagePath($row4['accountRank']);//수정부분
    ...
    if( $row3['2T_name'] != null && $row3['2T_name'] != "null" ) {
        ...
        $memberInfo[$a . '촌'][$n2 . '번']['색상코드'] = memberColor($row44['accountRank']);//수정부분
        $memberInfo[$a . '촌'][$n2 . '번']['이미지경로'] = imagePath($row44['accountRank']);//수정부분
    }
