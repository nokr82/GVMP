...
if ( $row2['accountType'] == "CU" && $row2['renewal'] != null ) {
...
?>
	...
	<section>
                    ...
                    <div id="Point_Calculation">
                        ...
                        <div id="coinhave"><h1 style="font-weight: 800;font-size: 16.38px;float: left; padding-top:20px; padding-left:20px; padding-bottom:10px; background-color: white;">보유 코인 현황</h1></div><br/>        
                            <div class="charge">
                                    <div class="v">
                                            <div>V coin</div>
                                            <div>
            ...
            <!--                        <div class="v">
                        ...
                        <p>
                            <a href="http://gvmp.company/myOffice/pay_cheak_skin.php" class="btn btn-red">정산 신청</a>
                        </p>
                        </div>
                        </div>
					...
					<div class="second_element">
						<ul>
							<li><input class="user_name" id="name" placeholder="name"
                                ...
                                <span id="accountTypeSpan"><?=$row11['accountType']?></span>
...
<!--    <section class="history">  월요일 이어하기
		<div>
			<h3>승급자 리스트</h3>
		</div>
		<div class="historyTableW">
...
<?php
    ...
    if( $renewalTitleRow['accountType'] == 'VM' || ($renewalTitleRow['accountType'] == "CU" && $renewalTitleRow['renewal'] != null) ) {
        echo '<div class="pop_tit">리뉴얼 결제</div>';
    } else if( $renewalTitleRow['accountType'] == 'CU' ) {
