...
define("BUILDDATE", "20190523");
define("AUTHOR", "naun_cjlee");
define("TID_LEN", 30);

define("NICEPAY_MODULE_CL","LITE"); // TX/LITE 구분
define("NICEPAY_MODULE_INFO","PHP_LITE_1.3.2"); // 모듈 상세 버전 정보

/*HTTP SERVER INFO*/
//----------------
//PRODUCTION
//----------------
define("HTTP_SERVER", "webapi.nicepay.co.kr");
define("HTTP_PORT", 80);

define("HTTP_SSL_SERVER", "webapi.nicepay.co.kr");
