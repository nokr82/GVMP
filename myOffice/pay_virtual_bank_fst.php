...
$retryUrl = "http://gvmp.company/myOffice/pay_virtual_inform.php"; // 가맹점 retryURL 설정
...
$stopUrl = "http://gvmp.company/myOffice/pay_virtual_bank_fst.php"; // 결제중지 URL
...
<script type="text/javascript">
    ...
    function goPay() {
        ...
        if ('<?=$Amt?>' != uncomma($('#Amt').val())) {
            location.href = 'http://gvmp.company/myOffice/pay_virtual_bank_fst.php?Amt='
