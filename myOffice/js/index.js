...
var services_data = [{ name: "메뉴1", icon: "industries" }, { name: "메뉴2", icon: "validation" }, { name: "회원ID 로그인 관리", icon: "engineering" }, { name: "메뉴4", icon: "management" }, { name: "메뉴5", icon: "manufacturing" }, { name: "메뉴6", icon: "technical" }, { name: "메뉴\n7", icon: "process" }];
