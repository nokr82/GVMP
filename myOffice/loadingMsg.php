...
.loading_wrap {display: none; position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: rgba(255,255,255,0.9); text-align: center}
...
<div class="loading_wrap">
    <div class="loading_content">
        <img class="loading_img" src="./images/vmp_loading_icon.gif" alt="로딩메세지"/>
