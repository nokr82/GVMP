...
<div id="sit_use_wbtn">
    <a href="<?php echo $itemuse_form; ?>" class="qa_wr itemuse_form " onclick="goTop();">사용후기 쓰기<span class="sound_only"> 새 창</span></a>
...
$(function(){
    $(".itemuse_form").click(function(){
        ...
        window.open(this.href, "itemuse_form", "width=810,height="+height+",scrollbars=1");
        return false;
    });
