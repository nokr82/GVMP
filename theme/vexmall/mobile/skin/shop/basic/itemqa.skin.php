...
<div id="sit_qa_wbtn">
    <a href="<?php echo $itemqa_form; ?>" class="itemqa_form qa_wr" <?if($member['mb_id']){?>onclick="goTop();"<?}?>>상품문의 쓰기<span class="sound_only"> 새 창</span></a>
    <a href="<?php echo $itemqa_list; ?>?it_id=<?=$it_id?>" id="itemqa_list" class="btn01">더보기</a>
</div>
        ...
        <li class="sit_qa_li">
            ...
            <div id="sit_qa_con_<?php echo $i; ?>" class="sit_qa_con">
                ...
                <div class="sit_qa_cmd">
                    <a href="<?php echo $itemqa_form."&amp;iq_id={$row['iq_id']}&amp;w=u"; ?>" class="itemqa_form btn01" onclick="window.scrollTo(0,0)">수정</a>
...
$(function(){
    $(".itemqa_form").click(function(){
        ...
        window.open(this.href, "itemqa_form", "width=810,height="+height+",scrollbars=1");
        return false;
    });
