...
<link rel="stylesheet" href="<?=G5_THEME_CSS_URL?>/modal.css">
<link rel="stylesheet" href="https://cdn.jsdelivr.net/bxslider/4.2.12/jquery.bxslider.css">
<script src="<?php echo G5_JS_URL; ?>/jquery.bxslider.js"></script>
<script src="<?=G5_THEME_JS_URL?>/modal.js"></script>
...
<?if($it['mb_id']&&$it['mb_id']!=$member['mb_id']){?>
<?if($member['accountType']!="VD"){?>
<div class="chatdiv">
	<div class="balloon">채팅<?=$mb_id?></div>
</div>
<?}?>
<?}?>
<div id="sit_ov_wrap2">
    <div class="detail_imgbox">
        <div class="de_head clearfix">
            <div class="back_img" onClick="history.back(-1)">
                <img src="<?=G5_THEME_IMG_URL?>/payment/vroad_back.svg" alt="뒤로가기버튼" />
            </div>
            <h3>제품상세</h3>
<!--             <div class="cart_img" onClick="location.href='/shop/cart.php'"> -->
...
if ($thumb_img)
{
	...
	echo '<div id="sit_pvi_slide" class="slider">'.PHP_EOL;
	echo $thumb_img;
	echo '</div>'.PHP_EOL;
	echo '</div>';
}
...
<!--            <button type="button" class="btn_sns_share"><i class="fa fa-share-alt" aria-hidden="true"></i><span class="sound_only">sns 공유</span></button>-->
        ...
        <div id="shareBtn" class="scroll_no btn btn-primary btn-lg">
            <a href="#none" class="share-kakaotalk"><img src="http://gvmp.company/theme/vexmall/img/store/vroad-store-item-share.svg" alt="카카오톡 링크보내기">공유하기</a>
        </div>
        <script>
        $(".share-kakaotalk").click(function(){
			window.VmpJsApp.shareItem("<?=$it_id?>");
//            $(".sns_area").show();
        });
...
<section id="sit_inf" class="sit_con">
    <h2>상품 정보</h2>
    <ul class="sanchor">
        <li class="on"><a href="#sit_inf" class="sanchor_on">상품정보</a></li>
...
<section id="sit_use" class="sit_con">
    ...
    <ul class="sanchor">
        ...
        <li class="on"><a href="#sit_use" class="sanchor_on">사용후기  <span class="item_use_count"><?php echo $item_use_count; ?></span></a></li>
        <li><a href="#sit_qa">상품문의 <span class="item_qa_count"><?php echo $item_qa_count; ?></span></a></li>
        <li><a href="#sit_dvr">배송정보</a></li>
        <li><a href="#sit_ex">교환정보</a></li>
        <li><a href="#sit_rel">관련상품</a></li>
...
<?
$row=sql_fetch("SELECT count(*) as cnt FROM g5_shop_cart WHERE mb_id = '{$member['mb_id']}' AND ct_status = '입금' AND it_id = '".$it_id."'");
if($row['cnt']){
?>
...
<?}else{?>
	<div id="itemuse">
		<div id="sit_use_wbtn">
		    <a href="#none" class="qa_wr itemuse_form " onclick="alert('구매하신 상품만 후기를 작성하실 수 있습니다.');">사용후기 쓰기<span class="sound_only"> 새 창</span></a>
		</div>
	</div>
<?}?>
</section>
...
<section id="sit_qa" class="sit_con">
    ...
    <ul class="sanchor">
        <li><a href="#sit_inf">상품정보</a></li>
        <li><a href="#sit_use">사용후기 <span class="item_use_count"><?php echo $item_use_count; ?></span></a></li>
        <li class="on"><a href="#sit_qa" class="sanchor_on">상품문의 <span class="item_qa_count"><?php echo $item_qa_count; ?></span></a></li>
        <li><a href="#sit_dvr">배송정보</a></li>
        <li><a href="#sit_ex">교환정보</a></li>
        <li><a href="#sit_rel">관련상품</a></li>
    </ul>
...
<section id="sit_dvr" class="sit_con">
    ...
    <ul class="sanchor">
        ...
        <li><a href="#sit_use">사용후기 <span class="item_use_count"><?php echo $item_use_count; ?></span></a></li>
        <li><a href="#sit_qa">상품문의 <span class="item_qa_count"><?php echo $item_qa_count; ?></span></a></li>
        <li class="on"><a href="#sit_dvr" class="sanchor_on">배송정보</a></li>
        <li><a href="#sit_ex">교환정보</a></li>
        <li><a href="#sit_rel">관련상품</a></li>
    </ul>
...
<section id="sit_ex" class="sit_con">
    ...
    <ul class="sanchor">
        ...
        <li><a href="#sit_qa">상품문의 <span class="item_qa_count"><?php echo $item_qa_count; ?></span></a></li>
        <li><a href="#sit_dvr">배송정보</a></li>
        <li class="on"><a href="#sit_ex" class="sanchor_on">교환정보</a></li>
        <li><a href="#sit_rel">관련상품</a></li>
    </ul>
...
<section id="sit_rel">
    ...
    <ul class="sanchor">
        ...
        <li><a href="#sit_dvr">배송정보</a></li>
        <li><a href="#sit_ex">교환정보</a></li>
        <li class="on"><a href="#sit_rel" class="sanchor_on">관련상품</a></li>
    </ul>
    <div class="sct_wrap">
        <?php
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body share_modal_body">
        <img src="<?=G5_THEME_IMG_URL?>/store/vroad-toggle-recom-img.png" alt="공유하기이미지" />
      </div>
      <div class="modal-footer">
          <a href="javascript:kakaolink_send('%ED%85%8C%EC%8A%A4%ED%8A%B8 %28 %EB%B7%B0%ED%8B%B0 %29 %7C VMP', 'http%3A%2F%2Fvmp.company%2Fshop%2Fitem.php%3Fit_id%3D1545284483');" class="share-kakaotalk" id="shareKakao">카카오톡으로 공유하기</a>
          <a href="#" id="urlCopy" value="">URL복사하기</a>
      </div>
    </div>
  </div>
...
$(".chatdiv").on("click",function(){
	$.ajax({ 
		type: 'POST', 
		url: '/vexMall/back/chatingRoomMake.php',
		dataType : 'json',
		data : {
			'it_id':'<?=$it['it_id']?>','mb_id':'<?=$member['mb_id']?>','am_id':'<?=$it['mb_id']?>','chattitle':'<?=$it['it_name']?>',
		},
		success: function(data) { 
			if(data.msg=="true"){
				window.VmpJsApp.chatmove(data.idx,data.title,data.image);
			}
		} 
	});	
});
...
$(function(){
	...
	$("#urlCopy").on("click",function(){
		$("#ShareUrl").val(window.document.location.href);
		$('#ShareUrl').css('display','block').select();
...
$(function(){
    ...
    $(window).scroll(function(){
        if( $(window).scrollTop() > 700 ) {
                ...
                $('.gg').height();
                $(".sit_ov_height").css("padding-top","400px");
//				$("#sit_use").css("padding-top","120px");
        } else {
                $('#sit_ov').removeClass("fixed");
                $('#sit_ov').addClass("static");
                $(".sit_ov_height").css("padding-top","0");
//				$("#sit_use").css("padding-top","0px");
        }
    });
