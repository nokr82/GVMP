...
<section id="bo_w">
    ...
    <div class="bo_w_link write_div">
        ...
        <input type="text" name="wr_10" value="<?php echo $write['wr_10'] ?>" id="wr_10" class="frm_input full_input" size="50" placeholder="예) https://www.youtube.com/watch?v=9bZkp7q19f0">
    </div>
