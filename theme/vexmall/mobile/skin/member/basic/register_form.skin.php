  ...
  <!-- <h2 style="background:#f2a80b;">후원인 팀배치</h2>
    ...
    <div class="form_01">
        ...
        <li class="reg_hp_box">
            ...
            <a href="#none" class="reg_hp_btn reg_hp_reconf_btn auth_number_btn">번호 변경하기</a>
            ...
            <div class="auth_number">
                <div class="auth_number_content">
                    ...
                    <div class="auth_step_2">
                        ...
                        <input class="" id="mb_hp" type="text" placeholder="휴대폰번호 입력" autocomplete="off" value="">
...
$('.auth_step_3 > a').on('click', function(){
    ...
    if( $(this).hasClass('btn_auth_ok') ){ // 변경 저장을 눌렀을 때
        ...
        if( $('#confirmedNum').val() == '' ){ 
            ...
            $('#reg_mb_hp').val( $('#confirmedNum').val() );
            $('.auth_number').removeClass('active');
            $('#reg_mb_hp').css('border','2px solid #354d90');
