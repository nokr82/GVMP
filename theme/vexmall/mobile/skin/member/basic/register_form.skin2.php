...
//        });
    ...
    <form name="fregisterform" id="fregisterform" onsubmit="return emailConf();" action="<?php echo $register_action_url ?>" method="post" enctype="multipart/form-data" autocomplete="off">
...
<!--        VD계정신청 <img src="http://www.blueb.co.kr/SRC/javascript/image1/forms/radiobutton.gif" name="option6" onclick="Check2(this.name,'')">
    ...
    <div class="form_01">
        ...
        <li>
            ...
            <input onkeydown="onlyNumber(this)" type="text" name="mb_hp" value="<?php // echo get_text($member['mb_hp']) ?>" id="reg_mb_hp" <?php echo ($config['cf_req_hp'])?"required":""; ?> class="frm_input full_input required <?php echo ($config['cf_req_hp'])?"required":""; ?>" maxlength="11" placeholder="휴대폰번호">
            <?php if ($config['cf_cert_use'] && $config['cf_cert_hp']) { ?>
...
// 계좌인증 팝업을 띄우는 JS
    ...
    <div class="form_01 agree">
        ...
        <li class="sms_con">
            ...
            <input type="checkbox" name="mb_sms" value="1" id="reg_mb_sms" <?php echo ($w=='' || $member['mb_sms'])?'checked':''; ?>>휴대폰 문자메세지를 받겠습니다.            
        </li>
        <?php } ?>
    ...
    function fregisterform_submit(f)
    {
        ...
        //이름과 예금주가 같은지 확인
        if ( $.trim($('#reg_mb_payment').val()) !== $.trim($('#reg_mb_name').val()) ){
