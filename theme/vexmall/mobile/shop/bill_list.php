...
//$mb_id = "00003571";
$sql = " select * from Receipt where mb_id = '".$mb_id."' order by billdate DESC";
        ...
        <li>
            <a href="#" class="rview">
                <div class="clearfix">
                    ...
                    <div class="text_box">
                        <p class="bill_name"><span>상호:</span><?=$row['billName']?></p>
...
<?}?>
    <button type="button" class="btn billBtn" onClick="location.href='/theme/vexmall/mobile/shop/mypage.php?mb_id=<?=$mb_id?>'">확인</button>
</div>
</form>
