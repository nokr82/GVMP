...
<!--                <li><a href="/myOffice/"><img src="/theme/everyday/mobile/shop/img/office.png"></a></li>
                ...
                <?php } else { ?>
                <li><a href="<?php echo G5_BBS_URL; ?>/login.php?url=<?php echo $urlencode; ?>"><img src="/theme/everyday/mobile/shop/img/vmp_main_page_02.png"></a></li>
                <li><a href="<?php echo G5_BBS_URL ?>/register.php" id="snb_join"><img src="/theme/everyday/mobile/shop/img/vmp_main_page_06.png"></a><!-- <div class="join-point"><span><?php echo $config['cf_register_point'] ?> P</span></div> --></li>
                <?php } ?>
        ...
        <!-- 팝업 메뉴 -->
    	 <div class="ct_popup">
    		<div class="ct_shop clearfix">
                    <div><a href="http://gvmp.company/shop/list.php?ca_id=10"><img src="/theme/everyday/mobile/shop/img/shop1.png"><p>VM몰</p></a></div>
                    <!--<div><a href="http://gvmp.company/shop/list.php?ca_id=90"><img src="/theme/everyday/mobile/shop/img/shop2.png"><p>VENDOR몰</p></a></div>-->
                </div>
                <ul> 
                        <li><a href="http://욜로몰.kr" target="_blank">libmall365<span>></span></a></li>
                        <li><a href="http://www.cjhellodirect.com/main.do?pcode=A2352" target="_blank">모바일샵<span>></span></a></li>
...
<!--        		<li><a href="http://gvmp.company/bbs/board.php?bo_table=gallery">광고<span>></span></a></li>
        ...
        <div class="ch_icon" >
        	<ul style="text-align: center; padding-top: 10%;">
        		...
        		<li style="display: inline-block; padding-left: 10%;"><a href="https://pf.kakao.com/_xnUxblC" id="custom-button-2"><img src="/theme/everyday/mobile/shop/img/kakaoplus2_03.png" style="width:80px;"></a></li>
                        <li> <div id="kakaostory-follow-button2" data-id="appinfou" data-type="vertical" data-show-follower-count="true"></div></li>
                </ul>
        </div>
