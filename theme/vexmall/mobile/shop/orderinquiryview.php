...
<div id="sod_fin">
    ...
    <div id="sod_fin_no"><strong><?php echo $od_id; ?></strong></div>
    ...
    <section class="sod_fin_list">
        ...
        <ul id="sod_list_inq" class="sod_list">
            ...
            for($i=0; $row=sql_fetch_array($result); $i++) {
                $image_width = 188;
                $image_height = 170;
                $image = get_it_image($row['it_id'], 188, 170, '', '', $row['it_name']);
        ...
        <ul>
             ...
             <li>
                <div class="pay_box clearfix">
                    ...
                    <p class="right_pay"><span><?php echo $wanbul; ?></span></p>
                </div>
            </li>
        </ul>
    </section>
