        ...
        <div class="odf_list">
            <ul>
                ...
                <li>
                    ...
                    <input type="hidden" name="od_addr_jibeon" value="<?php echo get_text($member['mb_addr_jibeon']); ?>" id='od_addr_jibeon'>
        ...
        <div class="odf_list">
            <ul>
                ...
                <li>
                    ...
                    <label for="od_b_addr3" class="sound_only">지번주소</label>
...
?>
        <h2 class="bar_add">보유 포인트</h2>
            <div id="od_have_price">
                 <span>VCash</span>
                 <div><strong>
                         <input id="vmc_point" class="point_input point_input_read" type='text' value="<?=$info['VCash']?>" onkeyup='return removeChar(event)'>
                         <input id="vmc_point_1" type="hidden" value="<?=$info['VCash']?>" >
                     </strong>원</div>
             </div>
            <div id="od_have2_price">
                 <span>VPay</span>
                 <div><strong>
                         <input id="vmp_point" class="point_input point_input_read" type='text' value="<?=$info['VPay']?>" onkeyup='return removeChar(event)'>
                         <input id="vmp_point_1" type="hidden" value="<?=$info['VPay']?>" >
                     </strong>원</div>
             </div>
