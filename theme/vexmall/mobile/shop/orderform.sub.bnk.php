        ...
        <div class="odf_list">
            <ul>
                ...
                <li>
                    ...
                    <input type="text" name="od_tel" value="<?php echo get_text($member['mb_hp']); ?>" id="od_tel" required class="frm_input required" maxlength="20">
                </li>
                <li>
                ...
                <li>
                    ...
                    <input type="hidden" name="od_addr_jibeon" value="<?php echo get_text($member['mb_addr_jibeon']); ?>" id='od_addr_jibeon'><br>
    ...
    <section id="sod_frm_pay">
        ...
        <div class="odf_tbl">
            ...
            <tr>
                ...
                <input id="all_money" class="point_input point_input_read" type='hidden' onkeyup='return removeChar(event)' readonly value="<?php echo number_format($tot_price); ?>">
            </tr>
             <tr>
                <th>추가배송비</th>
...
?>
        <h2 class="bar_add">보유 포인트</h2>
            ...
            <div id="od_point_price">
                <span>VMC</span>               
                <div><strong><input id="lend_money" class="point_input" type='text' onkeyup='return removeChar(event)' onfocusout="return removeChar(event)"></strong>원</div>
            </div>
            <div id="od_point2_price">
               <span>VMP</span>                
                <div><strong><input id="bite" class="point_input" type='text' onkeyup='return removeChar(event)' onfocusout="return removeChar(event)"></strong>원</div>
            </div>
...
function removeChar(event) {
    ...
    if ( keyID == 8 || keyID == 46 || keyID == 37 || keyID == 39 || keyID == 9 ) 
        ...
        //vmp, vmc포인트를 둘다 사용할때
        if (document.getElementById("lend_money").value && document.getElementById("bite").value) {

            document.getElementById('sum').value = parseInt(document.getElementById("all_money").value.replace(/,/g,"")) -  parseInt(document.getElementById('lend_money').value.replace(/,/g,"")) - parseInt(document.getElementById('bite').value.replace(/,/g,""));
	...
	//vmc포인트만 사용할때
        } else if (document.getElementById("lend_money").value) {
           document.getElementById('sum').value = String(parseInt(document.getElementById("all_money").value.replace(/,/g,"")) -  parseInt(document.getElementById('lend_money').value.replace(/,/g,"")));
            ...
            if(document.getElementById('sum').value < 0){ //대여금 변제된 값이 0이나 -값이 나오지 않도록 이벤트처리
             ...
             document.getElementById('sum').value = String(document.getElementById('sum').value).replace(/(\d)(?=(?:\d{3})+(?!\d))/g, '$1,');
        //vmp포인트만 사용할때    
	} else if (document.getElementById("bite").value) {
            document.getElementById('sum').value = String(parseInt(document.getElementById("all_money").value.replace(/,/g,"")) -  parseInt(document.getElementById('bite').value.replace(/,/g,"")));
        ...
        document.getElementById('od_temp_point').value = parseInt(a)+parseInt(b);
}
...
//            }
	...
	$("#order_address").click(function(){
        ...
        window.open(this.href, "win_address", "left=0,top=0,width=810,height="+height+",scrollbars=1");
...
function pay_approval()
{
    ...
    if( jQuery(pf).triggerHandler("form_sumbit_order_"+form_order_method) !== false ) {
        ...
        if( $("input[type=radio][name=od_settle_case]:checked").val() == "vmp_point" ) {
            ...
            document.getElementById('sm_od_temp_point').value = parseInt(a)+parseInt(b);
