...
<div id="listNav" class="clearfix">
    ...
    <div class="liststyle_list"></div>
    <div class="liststyle_pic on"></div>
</div>
    ...
    <ul>
        <li>
            <a href="#" class="clearfix">
                <div class="list_img">
                    <img src="<?=G5_THEME_IMG_URL?>/store_serch/test_pic.jpg" alt="asd" />
                </div>
                <div class="list_text">
                    <p class="ad">합리적인 쇼핑은 V로드에서!</p>
                    <h3>[브랜드 이름]상품의 이름이 들어갈 텍스트 입니다</h3>
                    <p class="pay">9,000원 <span class="sale">17,330원</span><span class="pay_2">무료배송</span></p>
                </div>
            </a>
        </li>
        <li>
