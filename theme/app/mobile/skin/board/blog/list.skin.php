...
<link href="http://gvmp.company/theme/everyday/mobile/skin/board/blog/list_skin.css" rel="stylesheet">
        ...
        <li class="<?php echo implode(' ', $classes); ?>">
            <div class="gall_box">
                ...
                <div class="gall_con">
                    ...
                    <div class="gall_text_href">
                        ...
                        <a href="<?php echo $list[$i]['href'] ?>" class="bo_tit">
                            ...
                            if( MobileCheck() == "Mobile" )
                                echo cut_str($list[$i]['subject'], 8); 
                            else
                                echo cut_str($list[$i]['subject'], 30); 
                    ...
                    <div class="gall_name">
                        <span class="sound_only">내용</span><p><a href="<?php echo $list[$i]['href'] ?>"><?php echo cut_str(strip_tags($list[$i]['wr_content']), 250)?></a></p>
                    </div>
                    <div class="gall_info">
                        <span class="sound_only">작성자</span><?php echo $list[$i]['name'] ?> 
                        <span class="sound_only">작성일</span><strong><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo date('y-m-d H:i', strtotime($list[$i]['wr_datetime']))?></strong> 
                        ...
                        <span class="gall_date"><span class="sound_only">더보기</span><a href="<?php echo $list[$i]['href'] ?>"><i class="fa fa-plus" aria-hidden="true"></i> 더보기</a></span>
                    </div>
                </div>
            </div>
        </li>
...
<!--            <option value="mb_id,1"<?php echo get_selected($sfl, 'mb_id,1'); ?>>회원아이디</option>
    ...
    <script>
        var $form_search = $('#bo_sch')
        ,   $form_btnGroup = $('#bo_sch, .bo_fx');
        
        $('#gall_ul').after($form_search);
        $form_btnGroup.wrapAll('<div class="clearfix" style="margin-bottom: 50px;"></div>');
        $('.bo_fx').before($form_search);
    </script>
</div>
