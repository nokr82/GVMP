        ...
        <div class="wrap">
            ...
            <!-- 로고영역 -->
                <div id="logo">
                	<a href="/bbs/board.php?bo_table=blog"> <!-- G5_SHOP_URL; -->
                		<img src="<?php echo G5_DATA_URL; ?>/common/mobile_logo_img" alt="<?php echo $config['cf_title']; ?> 메인">
                                <div class="logo_typo"><span>Vendor&nbsp;</span><span>Marketing&nbsp;</span><span>Platform</span></div>
                	</a>
                </div>
                <!-- 메뉴영역 -->
                ...
                <ul class="hd_log clearfix" id="hd_log_1">
                    ...
                    <li><a href="<?php echo G5_BBS_URL; ?>/logout.php?url=shop"><img src="/theme/everyday/mobile/shop/img/vmp_main_page_07.png"><p>로그아웃</p></a></li>
<!--                    <li><a href="/theme/everyday/mobile/skin/shop/basic/list.10.skin_gifts.php"><img src="/theme/everyday/img/Ordergift_btn.png"></a></li>-->
                    ...
                    <?php } else { ?>
                    <li><a href="<?php echo G5_BBS_URL; ?>/login.php?url=<?php echo $urlencode; ?>"><img src="/theme/everyday/mobile/shop/img/vmp_main_page_07.png"><p>로그인</p></a></li>
                    <li><a href="<?php echo G5_BBS_URL ?>/register.php" id="snb_join"><img src="/theme/everyday/mobile/shop/img/vmp_main_page_06.png"><p>회원가입</p></a><!-- <div class="join-point"><span><?php echo $config['cf_register_point'] ?> P</span></div> --></li>
                    <?php } ?>
                    ...
                    <li><a href="/shop/mypage.php"><img src="/theme/everyday/img/OrderHistory_btn.png"><p>주문내용</p></a></li>
                    <li><div id="cart_icon"><span class="cart_icon_1"><?php echo get_cart_count($tmp_cart_id); ?></span></div><a href="<?php echo G5_SHOP_URL; ?>/cart.php" class="tnb_cart"><span></span><img src="/theme/everyday/mobile/shop/img/vmp_main_page_05.png"><p>장바구니</p></a></li>
                </ul>
            </div>     
        </div>
