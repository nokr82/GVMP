...
//$shop_css = '';
//if (defined('_SHOP_')) {
    echo '<link rel="stylesheet" href="'.G5_THEME_CSS_URL.'/200923mobile_shop.css?ver='.G5_CSS_VER.'">'.PHP_EOL;
    //$shop_css = '_shop';
  //  echo '<link rel="stylesheet" href="'.G5_THEME_CSS_URL.'/200923'.(G5_IS_MOBILE?'mobile':'default').$shop_css.'.css">'.PHP_EOL;
//}
?>
<!--[if lte IE 8]>
