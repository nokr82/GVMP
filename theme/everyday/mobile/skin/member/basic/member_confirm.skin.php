...
<div id="mb_confirm" class="mbskin">
    ...
    <input type="hidden" name="mb_id" value="<?php echo $_GET['mb_id'] ?>">
    <input type="hidden" name="w" value="u">
    
    <fieldset>
        회원아이디
        <span id="mb_confirm_id"><?php if($_GET["mb_id"]!="") {echo $_GET["mb_id"];} else {echo $member['mb_id'];} ?></span>
...
if( $_GET["display"] == "false" ) {
    echo '<script>$("#hd_tnb").css("display", "none");</script>';
}
?>