...
<?php if ($config['cf_use_hp'] || $config['cf_cert_hp']) { ?>
                <li class="reg_hp_box">
                    ...
                    <input onkeydown="onlyNumber(this)" type="text" name="mb_hp" value="<?php echo get_text($member['mb_hp']) ?>" id="reg_mb_hp" <?php echo ($config['cf_req_hp']) ? "required" : ""; ?> class="frm_input full_input required <?php echo ($config['cf_req_hp']) ? "required" : ""; ?>" minlength="11" maxlength="11" title="휴대전화 번호" placeholder="휴대전화 번호를 숫자만 입력" onfocus="removeCursor(this)" required>
...
<?php } ?>
        ...
        <div class="form_01">
            ...
            <li>
                ...
                <input type="text" name="mb_accountHolder" id="reg_mb_payment" class="frm_input full_input <?php echo $required ?>" minlength="2" maxlength="20" <?php echo $required ?> placeholder="예금주">
            </li>
            <li>
