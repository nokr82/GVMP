...
//            document.getElementById(z).src = '/theme/everyday/mobile/skin/member/basic/img/radio.png';
    ...
    <?php } ?>
    <div class="join_title"><img src="/theme/everyday/mobile/skin/member/basic/img/vmp_join_form_180313_03.png"/></div>
    <form name="fregisterform" id="fregisterform" action="<?php echo $register_action_url ?>" onsubmit="return fregisterform_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="form_01 password_form">
            <h2 style="background:#1cb934;">비밀번호test 입력</h2>
            <li>
                ...
                ?>" id="reg_mb_id" class="frm_input full_input <?php echo $required ?> <?php echo $readonly ?>" minlength="3" maxlength="20" <?php echo $required ?> <?php echo $readonly ?> placeholder="아이디">
                <span id="msg_mb_id"></span>
                <span class="frm_info">* 영문자, 숫자, _ 만 입력 가능. 최소 3자이상 입력하세요.</span>
            </li>
            <li>
                <label for="reg_mb_password" class="sound_only">비밀번호<strong>필수</strong></label>
                <input type="password" name="mb_password" id="reg_mb_password" class="frm_input full_input <?php echo $required ?>" minlength="3" maxlength="20" <?php echo $required ?> placeholder="비밀번호" value="1234">
            </li>
            <li>
                <label for="reg_mb_password_re" class="sound_only">비밀번호 확인<strong>필수</strong></label>
                <input type="password" name="mb_password_re" id="reg_mb_password_re" class="frm_input full_input <?php echo $required ?>" minlength="3" maxlength="20" <?php echo $required ?>  placeholder="비밀번호확인" value="1234">
            </li>
            <br>
...
//                            async: false,
            ...
            <li>
                ...
                <input type="text" name="reg_mb_recommender" id="reg_mb_recommender" class="frm_input full_input <?php echo $required ?>" minlength="2" maxlength="20" <?php echo $required ?>  placeholder="추천인" value="능이소프트1">
            </li>
            <li>
                <label for="reg_mb_recommender_no" class="sound_only">추천인 회원번호<strong>필수</strong></label>
                <input onkeydown="onlyNumber(this)" maxlength="8" type="text" name="reg_mb_recommender_no" id="reg_mb_recommender_no" class="frm_input full_input <?php echo $required ?>" minlength="3" maxlength="20" <?php echo $required ?>  placeholder="추천인 회원번호" value="00003571">
        ...
        <div class="form_01">
            ...
            <li class="rgs_name_li">
                ...
                <input type="text" id="reg_mb_name" name="mb_name" value="퓨리홍1" <?php echo $required ?> <?php echo $readonly; ?> class="frm_input full_input <?php echo $required ?> <?php echo $readonly ?>" placeholder="이름">
            </li>
            <?php if ($req_nick) { ?>
                <li style="display:none;">
            ...
            <?php if ($config['cf_use_hp'] || $config['cf_cert_hp']) { ?>
                <li class="reg_hp_box">
                    ...
                    <input onkeydown="onlyNumber(this)" type="text" name="mb_hp" value="01041145671" id="reg_mb_hp" <?php echo ($config['cf_req_hp']) ? "required" : ""; ?> class="frm_input full_input required <?php echo ($config['cf_req_hp']) ? "required" : ""; ?>" minlength="11" maxlength="11" title="휴대전화 번호" placeholder="휴대전화 번호를 숫자만 입력" onfocus="removeCursor(this)" required>
            ...
            <li>
                ...
                <input type="email" name="mb_email" value="nokr82@1123.133" id="reg_mb_email" required class="frm_input email required" size="50" maxlength="100" placeholder="E-mail">

            </li>
            <li>
                <label for="reg_mb_tel" class="sound_only">생년월일<strong>필수</strong></label>
                <input onkeydown="onlyNumber(this)" maxlength="6" type="text" name="mb_birth" value="940105" id="reg_mb_tel" class="frm_input full_input required" maxlength="20" placeholder="생년월일 (ex. 890803)">
            </li>
            ...
            <?php if ($config['cf_use_addr']) { ?>
                <li>
                    ...
                    <input type="text" name="mb_zip" value="01000" id="reg_mb_zip" <?php echo $config['cf_req_addr'] ? "required" : ""; ?> class="frm_input required <?php echo $config['cf_req_addr'] ? "required" : ""; ?>" size="5" maxlength="6" placeholder="우편번호">
                    ...
                    <input type="text" name="mb_addr1" value="서울 강북구 방학로 382" id="reg_mb_addr1" <?php echo $config['cf_req_addr'] ? "required" : ""; ?> class="frm_input frm_address required <?php echo $config['cf_req_addr'] ? "required" : ""; ?>" size="50" placeholder="주소"><br>
                    <label for="reg_mb_addr2" class="sound_only">상세주소</label>
                    <input type="text" name="mb_addr2" value="강북구" id="reg_mb_addr2" class="frm_input frm_address required" size="50" placeholder="상세주소">
                    <br>
        ...
        <div class="form_01">
            ...
            <li>
                ...
                <select name="bankName" id="bankName" class="frm_input full_input <?php echo $required ?>">
                    ...
                    <option value="KB국민은행" selected="selected" >KB국민은행</option>
            ...
            <li>
                ...
                <input type="text" name="mb_accountHolder" id="reg_mb_payment" class="frm_input full_input <?php echo $required ?>" value="퓨리홍1" minlength="2" maxlength="20" <?php echo $required ?> placeholder="예금주">
            </li>
            <li>
                <label for="reg_mb_account" class="sound_only">계좌번호<strong>필수</strong></label>
                <input type="text" name="mb_accountNumber" id="reg_mb_account" class="frm_input full_input <?php echo $required ?>"  value="151515" minlength="3" maxlength="20" <?php echo $required ?> placeholder="계좌번호 (숫자만 입력)" onkeydown="onlyNumber(this)">
            </li>
            <!--        <li>
        ...
        <script>
            ...
            //        return false;
            //    }
            //    if( !($("#reg_mb_name").val() ==  $("#reg_mb_payment").val())) {
            ...
            // 휴대전화번호가 readonly일경우 커서없애기
            function removeCursor() {
                if ($('#reg_mb_hp').prop('readonly') == true) {
...
//    }
            ...
            // 연락처 중복 체크. 오픈 대기
//    var data = "mb_hp=" + $('#reg_mb_hp').val();
//    var returnCheck = true;
//    $.ajax({
//         url:'/myOffice/registerCheck.php',
//         type:'POST',
//         data: encodeURI(data),
//         async: false,
//         success:function(result){
...
//         return false;
            ...
            // 계좌정보 중복 체크. 오픈 대기
//    var data = "accountHolder=" + $('#reg_mb_payment').val() + "&accountNumber=" + $("#reg_mb_account").val();
//    var returnCheck = true;
//    $.ajax({
//         url:'/myOffice/registerCheck.php',
//         type:'POST',
