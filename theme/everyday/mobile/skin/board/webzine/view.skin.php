...
<!-- <div id="bo_v_table"><?php echo ($board['bo_mobile_subject'] ? $board['bo_mobile_subject'] : $board['bo_subject']); ?></div> -->
    <div class="btn_top top view_top"> 
        ...
        <?php if ($reply_href) { ?><a href="<?php echo $reply_href ?>" class="btn_b01 make_reply"><i class="fa fa-reply" aria-hidden="true"></i> 답변</a><?php } ?>
    </div>
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_link">
        ...
        if( $cnt == 0  ) {
                    echo "<style>#bo_v_link{display:none;}</style>";
                }
         ?>
        </ul>
    </section>
