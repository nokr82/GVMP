...
<div id="sit_ov_wrap">
    ...
    for ($i=1; $i<=10; $i++)
    {
		...
		if($it['ca_id']=="90"){
			$thumb = '<img src="'.$it['it_img'.$i].'" width="100%" height="100%">';
		}else{
...
<!--                            --><?php //if( $it['ca_id'] == "10" ) {echo '<tr><th scope="row">적립금</th><td>' . number_format( (int)str_replace(',', '', display_price(get_price($it))) * 0.05 ) . ' VMP</td></tr>';} ?><!-- VMP-->
...
$(function(){
    ...
    var stickyHeaderTop2 = $('#sit_pvi').height()+$('#sit_inf').height() - 200;
