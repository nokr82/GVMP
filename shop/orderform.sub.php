...
<div id="sod_frm">
    ...
    <div class="sod_left">
        <input type="hidden" name="od_price" id="od_price" value="<?php echo $tot_sell_price; ?>">
        <input type="hidden" name="org_od_price" id="org_od_price" value="<?php echo $tot_sell_price; ?>">
        ...
        <section id="sod_frm_orderer">
            ...
            <div class="tbl_frm01 tbl_wrap">
                ...
                <tr>
                    ...
                    <td><input type="text" name="od_tel" value="<?php echo get_text($member['mb_hp']); ?>" id="od_tel" required class="frm_input required" maxlength="20"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <br>
                        <input type="text" name="od_addr3" value="<?php echo get_text($member['mb_addr3']) ?>" id="od_addr3" class="frm_input frm_address" size="60" readonly="readonly" placeholder="지번주소">
                        <label for="od_addr3" class="sound_only">지번주소</label><br>
            ...
            <div class="tbl_frm01 tbl_wrap">
                ...
                <tr>
                    ...
                    <td id="sod_frm_addr">
                        ...
                        <input type="text" name="od_b_addr3" id="od_b_addr3" readonly="readonly" class="frm_input frm_address" size="60" placeholder="지번주소">
                        <label for="od_b_addr3" class="sound_only">지번주소</label><br>
...
<!--                <div id="sod_bsk_tot">
                <h2>포인트 사용</h2>
                    <ul>
                        <li class="sod_bsk_sell sell">
                            <span style="color:#1bb934">VMC</span>
                            <strong>3000</strong>원
                            <input type="text" name="vmcpoint" value="" placeholder="사용할포인트"  class="point_text">원
                        </li>
                        <li class="sod_bsk_coupon sell" id="coupon_plus2">
                            <span style="color:#f2a80a">VMR</span>
                            <strong>0</strong>원
                            <input type="text" name="vmrpoint" value="" placeholder="사용할포인트"  class="point_text">원
                        </li>
                        <li class="sod_bsk_dvr sell">
                            <span style="color:#fc565e">VMP</span>
                            <strong>10000</strong>원
                            <input type="text" name="vmppoint" value="" placeholder="사용할포인트"  class="point_text">원
                        </li>
                       <li class="sod_bsk_cnt sell">
                            <span>총계</span>
                            
                            <strong id="ct_tot_price"></strong>원
                        </li>
    ...
    <div class="sod_right">
        ...
        <div id="sod_bsk_tot">
            <ul>
                ...
                <li class="sod_bsk_coupon" style="display: none;">
                    <span>사용포인트</span>
                ...
                <li class="sod_bsk_point" style="display: none;">
                    <span>포인트</span>
...
<!--                <strong><?php echo number_format($tot_price); ?></strong>원-->
                <div><strong><input id="all_money" class="point_input point_input_read" type='text' onkeyup='return removeChar(event)' readonly value="<?php echo number_format($tot_price); ?>"></strong>원</div>
            </div>
...
?>
            ...
            <div id="od_have_price">
                 <span>VMC</span>
                 <div><strong>
                         <input id="vmc_point" class="point_input point_input_read" type='text' value="<?=$info['VMC']?>" onkeyup='return removeChar(event)'>
            ...
            <div id="od_have2_price">
                 <span>VMP</span>
                 <div><strong>
                         <input id="vmp_point" class="point_input point_input_read" type='text' value="<?=$info['VMP']?>" onkeyup='return removeChar(event)'>
            ...
            <div id="od_have4_price">
                 <span>VMM</span>
                 <div><strong>
                         <input id="vmm_point" class="point_input point_input_read" type='text' value="<?=$info['VMM']?>" onkeyup='return removeChar(event)'>
            ...
            <div id="od_have3_price">
                 <span>VCASH</span>
                 <div><strong>
                         <input id="vcash_point" class="point_input point_input_read" type='text' value="<?=$info['VCash']?>" onkeyup='return removeChar(event)'>
            ...
            <div id="od_have4_price">
                 <span>VPAY</span>
                 <div><strong>
                         <input id="vpay_point" class="point_input point_input_read" type='text' value="<?=$info['VPay']?>" onkeyup='return removeChar(event)'>
            ...
            <div id="od_point_price">
                <span>VMC</span>               
                <div><strong><input id="lend_money" class="point_input userpoint" type='text' alt="vmc" onkeyup='return removeChar(event)' onfocusout="return removeChar(event)" alt="vmc"></strong>원</div>
            </div>
            <div id="od_point2_price">
               <span>VMP</span>                
                <div><strong><input id="bite" class="point_input userpoint" type='text' alt="vmp" onkeyup='return removeChar(event)' onfocusout="return removeChar(event)" alt="vmp"></strong>원</div>
            </div>
            <div id="od_point4_price">
               <span>VMM</span>                
                <div><strong><input id="vmm_money" class="point_input userpoint" type='text' alt="vmm" onkeyup='return removeChar(event)' onfocusout="return removeChar(event)" alt="vmm"></strong>원</div>
            </div>
            <div id="od_point3_price">
               <span>VCASH</span>                
                <div><strong><input id="vcash_money" class="point_input userpoint" type='text' alt="vcash" onkeyup='return removeChar(event)' onfocusout="return removeChar(event)" alt="vcash"></strong>원</div>
            </div>
            <div id="od_point4_price">
               <span>VPAY</span>                
                <div><strong><input id="vpay_money" class="point_input userpoint" type='text' alt="vpay" onkeyup='return removeChar(event)' onfocusout="return removeChar(event)" alt="vpay"></strong>원</div>
            </div>
            <div id="od_last_price">
                <span>최종 결제금액</span>
                <div><strong><input id="sum" class="point_input point_input_read" type='text' onkeyup='return removeChar(event)' readonly value="<?php echo number_format($tot_price); ?>"></strong>원</div>
            </div>
<script>
/*
포인트 사용부분 신규
...
function getDisNumber(obj){
	return String(obj).replace(/(\d)(?=(?:\d{3})+(?!\d))/g, '$1,')
}
$(function(){
	/*
	$(".userpoint").keyup(function() {
		var SUMVALUE = 0;
		var ALLMONEY = getNumber($("#all_money").val());
		$.each($(".userpoint"),function(index,item){
			var USERORIGINOBJ = $(item).attr("alt");
			var ORIGINPOINT = "#"+USERORIGINOBJ + "_point_1";
			var DISPOINT = "#"+USERORIGINOBJ + "_point";
			var HIDENPOINT = "#"+USERORIGINOBJ + "F";
			var POINT = getNumber($(ORIGINPOINT).val())-getNumber($(item).val());
			
			if(POINT >= 0){ //포인트를 사용할 수 있다면
				$(DISPOINT).val(POINT);
				SUMVALUE += Number(getNumber($(item).val()));
				$(HIDENPOINT).val(getNumber($(item).val()));
			}else{
				alert("보유하고 있는 "+USERORIGINOBJ+"포인트가 더 적습니다.");
				$(item).val('');
				$(HIDENPOINT).val('0');
				$(DISPOINT).val($(ORIGINPOINT).val());
			}
		});
		$("#od_temp_point").val(SUMVALUE);
		$("#sum").val(getDisNumber(Number(ALLMONEY)-Number(SUMVALUE)));
	});
	*/
});
/*
...
//    }
	...
	if (document.getElementById("lend_money").value) {
		...
		if(document.getElementById('vmc_point').value < 0){ //대여금 변제된 값이 0이나 -값이 나오지 않도록 이벤트처리
	...
	//vmc를 안쓸때
	if($("#lend_money").val() == ""){ //대여금 변제된 값이 0이나 -값이 나오지 않도록 이벤트처리
                document.getElementById("vmc_point").value = document.getElementById("vmc_point_1").value;
                document.getElementById('vmc_point').value = String(document.getElementById('vmc_point').value).replace(/(\d)(?=(?:\d{3})+(?!\d))/g, '$1,');
        }
...
//                    $checked = '';
                ...
                <input type="radio" id="od_settle_point" name="od_settle_case" value="vmp_point" > <label for="od_settle_point" class="lb_icon bank_icon">포인트결제</label>
                
                <div class="sod_frm_point" style="display: none;">
                    <div>
...
$(function() {
    ...
    if( $('#vmmCheck').val() == "false" ) {
        $('#od_point4_price').css("display", "none");
        $('#od_have4_price').css("display", "none");
    }
