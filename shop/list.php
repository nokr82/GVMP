...
if ($member['accountType'] == 'VM' && $now_temp >= $timestamp_temp) {//권한설정 0622
    alert('접근권한이 없습니다.');
    exit();
}


if ($member['mall_yn'] != 'Y') {//권한설정 0622
    alert('접근권한이 없습니다.');
    exit();
}
...
//    echo G5_MSHOP_PATH.'/list2.php';
    include_once(G5_MSHOP_PATH . '/list2.php');
    return;
}
...
include_once(G5_PATH . '/200701head.php');
// 스킨경로
...
include_once('var/www/html/theme/vexmall/mobile/skin/shop/basic/search.skin.php');
