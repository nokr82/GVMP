...
?>
    ...
    <form name="fmember" id="fmember" action="./0715member_form_update.php" onsubmit="return fmember_submit(this);"
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><input type="text" name="mb_name" value="<?php echo $mb['mb_name'] ?>" id="mb_name" required
                               class="required frm_input" size="15" maxlength="20">

                        <label><input type="checkbox" id="rank_yn" name="rank_yn" value="Y" <?php if ($mb['rank_yn']=='Y') echo 'checked'?>>직급 강제 지정 여부</label>
                    </td>
                    <th scope="row">생년월일</th>
                    <td><input type="text" name="mb_birth" value="<?php echo $mb['birth'] ?>" id="mb_birth" required
                               class="required frm_input"></td>

                </tr>
                <tr id="rank_yn_row" hidden>
                    <th scope="row"><label for="">직급 강제 지정</label></th>
                    <td colspan="3">
                        <select name="accountRank" id="accountRank" class="">
                            <?php
                            $sql = "select * from rankOrderBy order by orderNum desc";
                            $rank = sql_query($sql);
                            while($row=sql_fetch_array($rank)){
                                if(strcasecmp($mb['accountRank'],$row['rankAccount']) == 0){
                                    echo "<option value=\"{$row['rankAccount']}\" selected>{$row['rankAccount']}</option>";
                                }else{
                                    echo "<option value=\"{$row['rankAccount']}\">{$row['rankAccount']}</option>";
                                }
                            } ?>
                        </select>
                    </td>
                ...
                <tr class="pos_rel">
                    ...
                    <td class="tbl_layout">
                        <span class="point">
                            ...
                            <input type="text" name="P_vmc" value="" id="vmc" class="frm_input" size="15" maxlength="20"
                                   onchange="getNumber(this);" onkeyup="getNumber(this);"><br>
                            ...
                            <input type="text" name="P_vmp" value="" id="vmp" class="frm_input" size="15" maxlength="20"
                                   onchange="getNumber(this);" onkeyup="getNumber(this);"><br>
                            <label for="vmc">VMM</label>
                            <input type="text" name="P_vmm" value="" id="vmm" class="frm_input" size="15" maxlength="20"
                                   onchange="getNumber(this);" onkeyup="getNumber(this);"><br>
                            <label for="biz">비즈머니</label>
                            <input type="text" name="P_biz" value="" id="biz" class="frm_input" size="15" maxlength="20"
                                   onchange="getNumber(this);" onkeyup="getNumber(this);"><br>
                            <label class="text_letter" for="vmg">금 고</label>
                            <input type="text" name="P_vmg" value="" id="vmg" class="frm_input" size="15" maxlength="20"
                                   onchange="getNumber(this);" onkeyup="getNumber(this);">
                        </span>
                        <span class="memo">
                            <label for="note_add">메시지</label><input type="text" id="note_add" name="note_add"/>
                        </span>
                    </td>
                    ...
                    <td class="tbl_layout">
                        <span class="point">
                            ...
                            <input type="text" name="M_vmc" value="" id="M_vmc" class="frm_input" size="15"
                                   maxlength="20" onchange="getNumber(this);" onkeyup="getNumber(this);"><br>
                            ...
                            <input type="text" name="M_vmp" value="" id="M_vmp" class="frm_input" size="15"
                                   maxlength="20" onchange="getNumber(this);" onkeyup="getNumber(this);"><br>
                            <label for="M_vmp">VMM</label>
                            <input type="text" name="M_vmm" value="" id="M_vmm" class="frm_input" size="15"
                                   maxlength="20" onchange="getNumber(this);" onkeyup="getNumber(this);"><br>
                            <label for="M_biz">비즈머니</label>
                            <input type="text" name="M_biz" value="" id="M_biz" class="frm_input" size="15"
                                   maxlength="20" onchange="getNumber(this);" onkeyup="getNumber(this);"><br>
                            <label class="text_letter" for="M_vmg">금 고</label>
                            <input type="text" name="M_vmg" value="" id="M_vmg" class="frm_input" size="15"
                                   maxlength="20" onchange="getNumber(this);" onkeyup="getNumber(this);">
                        </span>
                        <span class="memo">
                            <label for="note_min">메시지</label><input type="text" id="note_min" name="note_min"/>
                        </span>
                    </td>
                </tr>
    ...
    <td><input type="text" name="mb_tel" value="<?php echo $mb['mb_tel'] ?>" id="mb_tel" class="frm_input" size="15" maxlength="20"></td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" name="bankName" value="<?php echo $mb['bankName'] ?>" id="bankName" required
                               class="required frm_input" placeholder="은행명" style="margin: 0 0 5px 12px;"><br>
                        <label for="accountHolder">예금주</label>
                        <input type="text" name="accountHolder" value="<?php echo $mb['accountHolder'] ?>"
                               id="accountHolderbirth" required class="required frm_input" placeholder="예금주"
                               style="margin: 0 0 5px 12px;"><br>
                        <label for="accountNumber">계좌번호</label>
                        <input type="text" name="accountNumber" value="<?php echo $mb['accountNumber'] ?>"
                               id="accountNumber" required class="required frm_input" placeholder="계좌번호">
                    </td>
                    <th scope="row">카드결제<br>리브몰</th>
                    <td>
                        <label><input type="checkbox" name="card_possible" value="YES"
                                      style="margin-right: 5px" <?php if ($mb['payment'] == "YES") echo 'checked="checked"'; ?>>카드결제1
                            (웰컴) 가능</label><br>
                        <label><input type="checkbox" name="card_possible2" value="YES"
                                      style="margin-right: 5px" <?php if ($mb['payment2'] == "YES") echo 'checked="checked"'; ?>>카드결제2
                            (NICE) 가능</label><br>
                        <label><input type="checkbox" name="card_possible3" value="YES"
                                      style="margin-right: 5px" <?php if ($mb['payment3'] == "YES") echo 'checked="checked"'; ?>>카드결제3
                            (PayGo) 가능</label><br>
                        <label><input type="checkbox" name="yolo" value="YES"
                                      style="margin-right: 5px" <?php if ($mb['yolo'] == "YES") echo 'checked="checked"'; ?>>리브몰
                            사용 가능</label>
                    </td>
                </tr>
                <!-- <tr>
                ...
                <tr>
                    <th scope="row">일반 권한설정</th>
                    <td class="access_td">
                        <label><input type="checkbox" name="simple_renewal" value="YES"
                                      style="margin-right: 5px" <?php if ($mb['simpleRenewal'] == "YES") echo 'checked="checked"'; ?>>간편
                            리뉴얼</label><br>
                        <label><input type="checkbox" name="simple_join" value="YES"
                                      style="margin-right: 5px" <?php if ($mb['simpleJoin'] == "YES") echo 'checked="checked"'; ?>>간편
                            회원가입</label><br>
                        <label><input type="checkbox" name="settle_yn" value="Y"
                                      style="margin-right: 5px" <?php if ($mb['settle_yn'] == "Y") echo 'checked="checked"'; ?>>정산
                            신청</label><br>
                        <label><input type="checkbox" name="mall_yn" value="Y"
                                      style="margin-right: 5px" <?php if ($mb['mall_yn'] == "Y") echo 'checked="checked"'; ?>>VM몰</label>
                        <p class="info_notice">* 체크하시면 권한이 허용됩니다.</p>
                    </td>
                    <th scope="row">포인트전송 권한설정</th>
                    <td class="access_td">
                        <label><input type="checkbox" name="send_yn_p" value="P"
                                      style="margin-right: 5px" <?php if ($mb['send_yn'] == "Y" || $mb['send_yn'] == "P") echo 'checked="checked"'; ?>>P포인트
                            전송</label><br>
                        <label><input type="checkbox" name="send_yn_c" value="C"
                                      style="margin-right: 5px" <?php if ($mb['send_yn'] == "Y" || $mb['send_yn'] == "C") echo 'checked="checked"'; ?>>C포인트
                            전송</label>
                        <p class="info_notice">* 체크하시면 권한이 허용됩니다.</p>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="radio" name="mb_mailling" value="0"
                               id="mb_mailling_no" <?php echo $mb_mailling_no; ?>>
                ...
                <?php if ($is_admin == 'super') {
                    ...
                    <tr>
                        ...
                        <td colspan="3" class="j​urisdiction">
                            <div class="all_agree">
                                <input type="checkbox" id="allck" name="전체동의"/>
                                <label for="allck"><span>전체선택</span></label>
                            </div><!-- .all_agree -->
                            <?php
                            echo '<p>환경설정</p>';
                            $admin_sql = "select * from admin_menu where menu_category = 1";
                            ...
                            echo '<p>회원관리</p>';
                            $admin_sql = "select * from admin_menu where menu_category = 2";
                            $admin_menu = sql_query($admin_sql);
                            for ($i = 0; $admin_row = sql_fetch_array($admin_menu); $i++) {
                                echo "<label for='ck_{$admin_row['no']}'><input class ='admin_menu' type='checkbox' name='menu_list[]' id='ck_{$admin_row['no']}' value='{$admin_row['no']}'>{$admin_row['menu_title']}</label>";
                            };
                            ...
                            echo '<p>게시판관리</p>';
                            $admin_sql = "select * from admin_menu where menu_category = 3";
                            $admin_menu = sql_query($admin_sql);
                            for ($i = 0; $admin_row = sql_fetch_array($admin_menu); $i++) {
                                echo "<label for='ck_{$admin_row['no']}'><input class ='admin_menu' type='checkbox' name='menu_list[]' id='ck_{$admin_row['no']}' value='{$admin_row['no']}'>{$admin_row['menu_title']}</label>";
                            };
                            ...
                            echo '<p>쇼핑몰관리</p>';
                            $admin_sql = "select * from admin_menu where menu_category = 5";
                            $admin_menu = sql_query($admin_sql);
                            for ($i = 0; $admin_row = sql_fetch_array($admin_menu); $i++) {
                                echo "<label for='ck_{$admin_row['no']}'><input class ='admin_menu' type='checkbox' name='menu_list[]' id='ck_{$admin_row['no']}' value='{$admin_row['no']}'>{$admin_row['menu_title']}</label>";
                            };
                            ...
                            echo '<p>쇼핑몰현황/기타</p>';
                            $admin_sql = "select * from admin_menu where menu_category = 4";
                            $admin_menu = sql_query($admin_sql);
                            for ($i = 0; $admin_row = sql_fetch_array($admin_menu); $i++) {
                                echo "<label for='ck_{$admin_row['no']}'><input class ='admin_menu' type='checkbox' name='menu_list[]' id='ck_{$admin_row['no']}' value='{$admin_row['no']}'>{$admin_row['menu_title']}</label>";
                            };
                            ...
                            echo '<p>SMS관리</p>';
                            $admin_sql = "select * from admin_menu where menu_category = 6";
                            $admin_menu = sql_query($admin_sql);
                            for ($i = 0; $admin_row = sql_fetch_array($admin_menu); $i++) {
                                echo "<label for='ck_{$admin_row['no']}'><input class ='admin_menu' type='checkbox' name='menu_list[]' id='ck_{$admin_row['no']}' value='{$admin_row['no']}'>{$admin_row['menu_title']}</label>";
                            };
                                        ...
                                        foreach ($my_social_accounts as $account) {     //반복문
                                            ...
                                            <div class="account_provider"
                                                ...
                                                <div class="btn_info"><a
                                                            ...
                                                            class="social_unlink"
                                                            data-provider="<?php echo $account['mp_no']; ?>">연동해제</a>
                                                    <span class="sound_only"><?php echo substr($account['mp_register_day'], 2, 14); ?></span>
                                                </div>
                                            </div>
                                        <?php } //end foreach      ?>
                                    </li>
        ...
        <div class="btn_fixed_top">
            ...
            <input type="submit" value="확인" class="btn_submit btn" accesskey='s' onclick="">
        </div>
        <script>
    ...
    <style>
        ...
        tr td.j​urisdiction p {
            font-weight: bold;
            padding-top: 10px;
        }

        tr td.j​urisdiction label {
            padding-left: 10px;
        }

        tr td.j​urisdiction input {
            margin-right: 5px;
        }

        /* 2019년 11월 21일 추가, 회원포인트-메시지 인풋 */
        .pos_rel td {
            position: relative;
            display: flex;
            flex-direction: row;
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            if ($('#rank_yn').prop('checked')){
                $('#rank_yn_row').show();
            }

            $('#rank_yn').change(function () {
                if ($('#rank_yn').prop('checked')){
                    $('#rank_yn_row').show();
                }else {
                    $('#rank_yn_row').hide();
            ...
            $("#allck").click(function () {
                if ($("#allck").prop("checked")) {
                    $(".admin_menu").prop("checked", true);
                } else {
                    $(".admin_menu").prop("checked", false);
                }
            })
    ...
    <script>
        ...
        function fmember_submit(f) {
            ...
            var M_vmm = $('#M_vmm').val();
            var M_vmg = $('#M_vmg').val();
            var note_min = $('#note_min').val();


            if (vmc != '' || vmp != '' || vmm != '' || biz != '' || vmg != '') {
                if (note_add != '') {
                    doubleSubmitCheck();
                    return;
                } else {
            ...
            if (M_vmc != '' || M_vmp != '' || M_biz != '' || M_vmm != '' || M_vmg != '') {
                if (note_min != '') {
                    doubleSubmitCheck();
                    return;
                } else {
...
//        }
            ...
            if (!f.vmp.value == '') {
                alert('회원이미지33333는 이미지 파일만 가능합니다.');
                return false;
            }
            if (!f.P_vmc.value) {
                alert("sadasd");
