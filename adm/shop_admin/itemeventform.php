...
<input type="hidden" name="ev_skin" value="list.10.skin.php">
<input type="hidden" name="ev_mobile_skin" value="list.10.skin.php">
<input type="hidden" name="ev_list_mod" value="1" id="ev_list_mod">
<input type="hidden" name="ev_list_row" value="<?php echo $ev['ev_list_row']; ?>">
<input type="hidden" name="ev_mobile_img_width" value="<?php echo $ev['ev_mobile_img_width']; ?>">
<input type="hidden" name="ev_mobile_img_height" value="<?php echo $ev['ev_mobile_img_height']; ?>">
<input type="hidden" name="ev_mobile_list_mod" value="<?php echo $ev['ev_mobile_list_mod']; ?>">
<input type="hidden" name="ev_mobile_list_row" value="<?php echo $ev['ev_mobile_list_row']; ?>">
...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        <th scope="row"><label for="ev_img_width">이벤트 날짜</label></th>
        <td>
			<input type="text" name="ev_start_date" value="<?php echo substr($ev['ev_start_date'],0,10); ?>" id="ev_start_date" required class="required frm_input" size="10">
			  ~
			<input type="text" name="ev_end_date" value="<?php echo substr($ev['ev_end_date'],0,10); ?>" id="ev_end_date" required class="required frm_input" size="10">
        </td>
    </tr>
    <!--tr>
...
<script>
$(function() {
	$("#ev_start_date, #ev_end_date").datepicker({ changeMonth: true, changeYear: true, dateFormat: "yy-mm-dd", showButtonPanel: true, yearRange: "c-99:c+99" });
