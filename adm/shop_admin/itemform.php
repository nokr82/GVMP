...
<section id="anc_sitfrm_ini">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="sale_mb_id">판매자 아이디</label></th>
            <td colspan="2">
                <input type="text" name="sale_mb_id" value="<?php echo $it['mb_id']; ?>" id="sale_mb_id" class="frm_input" size="40">
            </td>
        </tr>
        ...
        <tbody>
            ...
            <tr id="sc_con_basic">
                ...
                <td>
                    ...
                    <input type="text" name="it_sc_price" value="<?php echo $it['it_sc_price']; ?>" id="it_sc_price" class="frm_input" onkeydown="onlyNumber(this)" size="8"> 원
                </td>
            </tr>
            <tr id="sc_con_minimum">
                <th scope="row"><label for="it_sc_minimum">배송비 상세조건</label></th>
                <td>
                    주문금액 <input type="text" name="it_sc_minimum" value="<?php echo $it['it_sc_minimum']; ?>" id="it_sc_minimum" class="frm_input" onkeydown="onlyNumber(this)" size="8"> 이상 무료 배송
                </td>
            </tr>
            <tr id="sc_con_qty">
                ...
                <td>
                    ...
                    주문수량 <input type="text" name="it_sc_qty" value="<?php echo $it['it_sc_qty']; ?>" id="it_sc_qty" class="frm_input" onkeydown="onlyNumber(this)" size="8"> 마다 배송비 부과
                </td>
            </tr>
        </tbody>
        </table>
