...
if($is_admin=="super" || $is_admin=="manager"){
	$sql_common = " from (select a.* from {$g5['g5_shop_order_table']} as a left outer join g5_shop_cart as b on a.od_id = b.od_id left outer join {$g5['g5_shop_item_table']} as c on b.it_id = c.it_id $sql_search group by a.od_id ) as a ";
}else{
...
<input type="text" name="search" value="<?php echo $search; ?>" id="search" class="required frm_input" autocomplete="off">
