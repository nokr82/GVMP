...
if ($w == "") {
    if ($is_admin != 'super' && $is_admin != 'manager' && !$ca_id)
...
/*
    ...
    if ($ca_id == 10) {
        $subid = $ca_id . $row['max_subid'];
        $subid = ++$subid;
        $subid = substr($subid, -2);
        $subid = $ca_id . $subid;
    } else {
...
//동우수정 카테고리아이디설정 0626
    ...
    for ($i = 0; $i < 99; $i++) {
        $cate = $i;
        $cate = substr("00" . $cate, -2);
        $sql = "select * from g5_shop_category where ca_id = '10{$cate}'";
        $row = sql_fetch($sql);
        if (!$row){
            $subid = '10'.$cate;
            break;
...
?>
    ...
    <form name="fcategoryform" action="./categoryformupdate.php" onsubmit="return fcategoryformcheck(this);"
        ...
        <section id="anc_scatefrm_basic">
            ...
            <div class="tbl_frm01 tbl_wrap">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php } else { ?>
                                ...
                                <a href="<?php echo G5_SHOP_URL; ?>/list.php?ca_id=<?php echo $ca_id; ?>"
                                   class="btn_frmline">미리보기</a>
                                <a href="./categoryform.php?ca_id=<?php echo $ca_id; ?>&amp;<?php echo $qstr; ?>"
                                   class="btn_frmline">하위분류 추가</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($is_admin == 'super') { ?>
                                <input type="text" name="ca_mb_id" value="<?php echo $ca['ca_mb_id']; ?>" id="ca_mb_id"
                    ...
                    <tr>
                        <th scope="row">앱 사용 유무 체크</th>
                        <td>
                            <input type="radio" name="app_icon_use" value="Y"
                                   id="app_icon_use_yes" <?php if ($ca['vexMallCheck'] == "Y") echo 'checked="checked"'; ?>>
                            <label for="app_icon_use_yes">사용함</label>
                            <input type="radio" name="app_icon_use" value="N"
                                   id="app_icon_use_no" <?php if ($ca['vexMallCheck'] == "N") echo 'checked="checked"'; ?>>
                            <label for="app_icon_use_no">사용안함</label>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">앱 아이콘 지정</th>
                        <td>
                            <div class="app_icon_area">
                                <img src="/vexMall/images/category/<?php echo $ca['imagePath']; ?>"
                                     onerror="this.src='/adm/img/no_images.png'"/>
                            </div>
                            <input type="file" name="app_icon_img" id="app_icon_img">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="radio" name="ca_cert_use" value="1"
                                   id="ca_cert_use_yes" <?php if ($ca['ca_cert_use']) echo 'checked="checked"'; ?>>
                            <label for="ca_cert_use_yes">사용함</label>
                            <input type="radio" name="ca_cert_use" value="0"
                                   id="ca_cert_use_no" <?php if (!$ca['ca_cert_use']) echo 'checked="checked"'; ?>>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="radio" name="ca_adult_use" value="1"
                                   id="ca_adult_use_yes" <?php if ($ca['ca_adult_use']) echo 'checked="checked"'; ?>>
                            <label for="ca_adult_use_yes">사용함</label>
                            <input type="radio" name="ca_adult_use" value="0"
                                   id="ca_adult_use_no" <?php if (!$ca['ca_adult_use']) echo 'checked="checked"'; ?>>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="ca_sell_email" size="40"
                                   value="<?php echo $ca['ca_sell_email']; ?>" id="ca_sell_email" class="frm_input">
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="checkbox"
                                   name="ca_nocoupon" <?php echo ($ca['ca_nocoupon']) ? "checked" : ""; ?> value="1"
                                   id="ca_nocoupon">
                            예
                        </td>
                    </tr>
                    ...
                    <?php for ($i = 1; $i <= 10; $i++) { ?>
                        <tr>
                            ...
                            <td class="td_extra">
                                ...
                                <input type="text" name="ca_<?php echo $i ?>"
                                       value="<?php echo get_text($ca['ca_' . $i]) ?>" id="ca_<?php echo $i ?>"
                                       class="frm_input">
                            </td>
                        </tr>
                    <?php } ?>
    ...
    <script>
        ...
        //앱 아이콘 선택시 밴더몰카테고리 인지 판별
        $('#app_icon_img').click(function () {
            var app_ca_id = $('input[name=ca_id]').val();
            var app_id = app_ca_id.substring(0, 2);
            if (app_id != 90) {
                alert('앱 아이콘 지정은 벤더몰의 카테고리만 사용 가능합니다.');
                return false;
            }
        });
        ...
        function fcategoryformcheck(f) {
            ...
            if ($('#app_icon_use_yes').attr('checked')) {
                if (app_id != 90) {
                    alert('앱 사용은 벤더몰의 카테고리만 가능합니다.');
                    $('#app_icon_use_yes').attr('checked', false);
                    $('#app_icon_use_no').attr('checked', true);
                    return false;
                }
            }
