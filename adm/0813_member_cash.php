    ...
    <form name="fvisit" id="fvisit" class="local_sch03 local_sch" method="get" action="member_cash.php">
        <div class="sch_last" id="date" style="width: 60%">
            ...
            <select name="cash_year" id="cash_year">
                <option value=""></option>
                <option value="2018" <?php if($y=="2018") {echo 'selected="selected"';} ?>>2018</option>
                <option value="2019" <?php if($y=="2019") {echo 'selected="selected"';} ?>>2019</option>
                <option value="2020" <?php if($y=="2020") {echo 'selected="selected"';} ?>>2020</option>
                <option value="2021" <?php if($y=="2021") {echo 'selected="selected"';} ?>>2021</option>
                <option value="2022" <?php if($y=="2022") {echo 'selected="selected"';} ?>>2022</option>
                <option value="2023" <?php if($y=="2023") {echo 'selected="selected"';} ?>>2023</option>
                <option value="2024" <?php if($y=="2024") {echo 'selected="selected"';} ?>>2024</option>
                <option value="2025" <?php if($y=="2025") {echo 'selected="selected"';} ?>>2025</option>
                <option value="2026" <?php if($y=="2026") {echo 'selected="selected"';} ?>>2026</option>
                <option value="2027" <?php if($y=="2027") {echo 'selected="selected"';} ?>>2027</option>
                <option value="2028" <?php if($y=="2028") {echo 'selected="selected"';} ?>>2028</option>
            </select>
            ...
            <select name="cash_month" id="cash_month">
                ...
                <option value="11" <?php if($m=="11") {echo 'selected="selected"';} ?>>11</option>
                <option value="12" <?php if($m=="12") {echo 'selected="selected"';} ?>>12</option>
            </select>
            <label for="" class="">월</label>

            <select name="cash_b" id="cash_b">
                <option value=""></option>
                <option value="1" <?php if($b=="1") {echo 'selected="selected"';} ?>>1분기</option>
                <option value="2" <?php if($b=="2") {echo 'selected="selected"';} ?>>2분기</option>
            </select>
            <label for="" class="">분기</label>


            <label for="" class="">아이디 : </label>
            <input type="text" id="cash_id" name="cash_id">
