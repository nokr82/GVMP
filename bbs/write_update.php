...
if ($w == '' || $w == 'r') {
    ...
    $tempSQL = "";
    if( $write_table == "g5_write_used" ) {
        $_POST["wr_price"] = preg_replace("/[^0-9]/", "",$_POST["wr_price"]);
        $tempSQL .= "summaryInfo = '{$_POST["wr_sub_subject"]}', price = {$_POST["wr_price"]}, seller_hp = '{$_POST["wr_mb_number"]}',";
    }
