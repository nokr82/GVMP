...
//include_once($_SERVER['DOCUMENT_ROOT'] . '/theme/everyday/mobile/skin/shop/basic/mainbanner.10.skin.php');
...
include_once($_SERVER['DOCUMENT_ROOT'].'/theme/everyday/mobile/shop/200923shop.head.php');
...
if ($member['mb_level'] >= $board['bo_list_level'] && $board['bo_use_list_view'] || empty($wr_id))
    if ($board['bo_table'] == 'free'){
        include_once (G5_BBS_PATH.'/boardNew/list.php');
    }elseif ($board['bo_table'] == 'youtube'){
        include_once (G5_BBS_PATH.'/boardNew/gallery.php');
    } else {
...
include('/var/www/html/gvmp/theme/everyday/mobile/shop/shop.tail.php');

?>

<!-- mj추가 20.08.20
* 파일 게시판, 유튜브 게시판일 때 버튼 모양 변경 -->
<?php
if ( $board['bo_table'] == "free" || $board['bo_table'] == "youtube" ) {
?>
<script> 
    var posting_bbs = document.querySelector('#bo_v');
    posting_bbs.classList.add('free_bbs');
</script>
<?php
}
?>