...
if( $_GET['mb_name'] == null || $_GET['mb_id'] == null ) {
    echo "<script>alert('등록할 수 없는 자리입니다.');close();</script>";
}
...
echo "<style>#hd{display:none;}</style>";
...
$register_action_url = 'myOfficeMBRegister.php';
...
include_once($member_skin_path.'/register_form.skin_zy.php');
include_once('./_tail.php');
echo "<style>#ft{display:none;}</style>";
?>