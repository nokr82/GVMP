...
$register_action_url = G5_HTTPS_BBS_URL.'/register_form_update_test.php';
...
// /var/www/html/gvmp/theme/vexmall/mobile/skin/member/basic
//echo $member_skin_path . "<br>";

include_once($member_skin_path.'/register_form.skin_test.php');
