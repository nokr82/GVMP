    ...
    <table width="589" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td style="background-image:url('.././img/boxbg589.gif')" align="center">
                ...
                <table width="551" cellspacing="0" cellpadding="16">
                    <tr style="height:17px">
                        <td style="background-image:url('.././img/ttbg551.gif');border:0px" class="white">
                            <span class="bold big">[SMS 발송요청]</span> 이 페이지는 샘플(예시) 페이지입니다.
                        </td>
                    </tr>
                    <tr>
                        <td style="background-image:url('.././img/boxbg551.gif') ;">
                            ...
                            <p class="align_left">이 페이지는 SMS발송을 요청하는 페이지 입니다.</p>
                        </td>
                    </tr>
                ...
                <!-- SMS발송 요청 정보 입력 테이블 Start -->
                <table width="527" cellspacing="0" cellpadding="0" class="margin_top_20">
                    <tr><td colspan="2" class="title">SMS 발송 요청 정보</td></tr>
                    <!-- 요청 구분 : 취소 -->
                    <tr>
                        <td class="sub_title1">요청 구분</td>
                        <td class="sub_content1 bold">SMS발송 요청</td>
                    </tr>
                    
					<!-- Input : 결제된 건의 거래번호(14 byte) 입력 -->
                    <tr>
                        <td class="sub_title1">KCP 등록 거래번호</td>
                ...
                <table width="527" cellspacing="0" cellpadding="0" class="margin_top_20">
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            <input type="image" src=".././img/btn_cancel.gif" onclick="return jsf__go_cancel(this.form);" width="108" height="37" alt="SMS 발송을 요청합니다" /></a>
