...
<div class="local_ov01 local_ov">
    ...
    <span class="btn_ov01"><span class="ov_txt"> 전체 FAQ </span>
        <span class="ov_num"><?php // echo $total_count; ?>관리</span>
    </span>
</div>

<div class="local_desc01 local_desc">
    <ol>
        <li>해당 <strong>제목</strong>을 눌러 세부 내용을 추가,수정 관리할 수 있습니다.</li>
    </ol>
</div>
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" colspan="2">FAQ수</th>
        <!--<th scope="col">순서</th>-->
        <th scope="col">관리</th>
    </tr>
    </thead>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="td_num" colspan="2"><?php echo $cnt; ?></td>
        <!--<td class="td_num">-->
            <?php // echo $row['fm_order']?>
        <!--</td>-->
        <td class="td_mng td_mng_l">
            <!--수정, 삭제 주석처리 // 19-08-27 이지양--> 
            <!--<a href="./faqmasterform.php?w=u&amp;fm_id=-->
                <?php // echo $row['fm_id']; ?>
            <!--" class="btn btn_03"><span class="sound_only">-->
            ...
            <!--<a href="./faqmasterformupdate.php?w=d&amp;fm_id=-->
                <?php // echo $row['fm_id']; ?>
            <!--" onclick="return delete_confirm(this);" class="btn btn_02"><span class="sound_only">-->
                <?php // echo stripslashes($row['fm_subject']); ?>
            <!--</span>삭제</a>-->
        </td>
    </tr>
