...
function captcha_html($class="captcha")
{
    ...
    $html .= '<input type="number" name="captcha_key" id="captcha_key" required class="captcha_box required" size="6" maxlength="6" placeholder="자동등록방지 숫자를 순서대로 입력하세요.">';
    if (!is_mobile()) $html .= "\n".'<button type="button" id="captcha_mp3"><span></span>숫자음성듣기</button>';
    $html .= "\n".'<button type="button" id="captcha_reload"><i class="fas fa-redo"></i><span></span>새로고침</button>';
