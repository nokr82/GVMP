...
<select name="sfl" id="sfl">
    ...
    <option value="point"<?php echo get_selected($_GET['sfl'], "point"); ?>>포인33트</option>
...
<!-- 191213 추가, 계정별 검색 선택버튼 -->
<div class="search_link">
	<p>계정별 바로 검색하기</p>
	<button class="color_07">버니</button>
	<button class="color_08">일반</button>
</div>
</form>
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" id="mb_list_tel">계정종류(사업자)</th>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td headers="mb_list_tel" class="td_tel"><?php echo get_text($row['accountType'])."({$row['buisnessman']})"; ?></td>
        <td headers="mb_list_join" class="td_date"><?php echo substr($row['mb_datetime'],2,8); ?></td>
        <td headers="mb_list_point" class="td_num"><?php echo number_format($row['point']) ?></td>
