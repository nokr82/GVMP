...
<header id="hd">
    ...
    <nav id="gnb" class="gnb_large <?php echo $adm_menu_cookie['gnb']; ?>">
        ...
        <ul class="gnb_ul">
            ...
            ?>
<!--            <li class="gnb_li">
                <button type="button" class="btn_op menu_beosyoung" title="버숑메뉴">버숑메뉴</button>
                <div class="gnb_oparea_wr">
                    <div class="gnb_oparea">
                        <h3>버숑메뉴</h3>
                        <ul>
                            <li>
                                <a href="./withdraw_list.php">출금 신청 내역</a>
                            </li>
                            <li>
                                <a href="#none">포인트 지급 내역</a>
                            </li>
                            <li>
                                <a href="./apply_bn_list.php">버니 결제 내역</a>
                            </li>
                            <li>
                                <a href="#none">버숑 체험단,인스타그램 체험단</a>
                            </li>
                            <li>
                                <a href="#none">언론 마케팅</a>
                            </li>                            
                        </ul>
                    </div>
                </div>
