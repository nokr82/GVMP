...
//        echo '<form id="forderform" name="forderform" method="post" action="'.'/shop/orderformupdate.php'.'" autocomplete="off">'.PHP_EOL;
//
...
//        }
//        echo '<input type="hidden" name="od_settle_case" value="vmp_point">'.PHP_EOL;
//        echo '</form>'.PHP_EOL;
//        
//        echo "<script>document.getElementById(\"forderform\").submit();</script>";
//        exit();
//    }
