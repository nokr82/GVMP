...
if (defined('G5_THEME_SHOP_PATH')) {
    // /var/www/html/gvmp/theme/vexmall/mobile/shop/orderform.sub.php
    $theme_inquiry_file = G5_THEME_MSHOP_PATH . '/orderform.sub.php';
    ...
    <ul class="sod_list">
        ...
        for ($i = 0; $row = sql_fetch_array($result); $i++) {
            ...
            if ($is_member) {
                ...
                if ($row['ca_id'] != "10") {
                    echo "<input type='hidden' id='vmmCheck' value='false'>";
                }
            ...
            <li class="sod_li">
                <input type="hidden" name="it_sale_mb_id[<?php echo $i; ?>]"    value="<?php echo $row['mb_id']; ?>">
                ...
                <div class="li_prqty">
                    ...
                    <!--<span class="total_point li_prqty_sp"><span>적립포인트 </span><strong>-->
                    <?php // echo number_format($sum['point']);
                    ?>
                    <!--</strong></span>-->

                </div>
                <div class="total_price total_span">
                    <span>주문금액 </span><strong><?php echo number_format($sell_price); ?></strong></div>
...
<div id="sod_frm">
    <form name="forderform" id="forderform" method="post" action="<?php echo $order_action_url; ?>" autocomplete="off">
        <input type="hidden" id="vmcF" name="vmcF" value="0">
        <input type="hidden" id="vmpF" name="vmpF" value="0">
        <input type="hidden" id="vmmF" name="vmmF" value="0">
        <input type="hidden" id="vcashF" name="vcashF" value="0">
        <input type="hidden" id="vpayF" name="vpayF" value="0">
        <input type="hidden" id="od_price" name="od_price" value="<?php echo $tot_sell_price; ?>">
        <input type="hidden" id="org_od_price" name="org_od_price" value="<?php echo $tot_sell_price; ?>">
        <input type="hidden" id="od_send_cost" name="od_send_cost" value="<?php echo $send_cost; ?>">
        <input type="hidden" id="od_send_cost2" name="od_send_cost2" value="0">
        <input type="hidden" id="item_coupon" name="item_coupon" value="0">
        <input type="hidden" id="od_coupon" name="od_coupon" value="0">
        <input type="hidden" id="od_send_coupon" name="od_send_coupon" value="0">
            ...
            <div class="odf_list">
                <ul>
                    <li>
                        ...
                        <input type="text" name="od_name" value="<?php echo get_text($member['mb_name']); ?>"
                    ...
                    <li>
                        ...
                        <input type="text" name="od_tel" value="<?php echo get_text($member['mb_hp']); ?>" id="od_tel"
                               required class="frm_input required" maxlength="20">
                    </li>
                    <li>
                        <label for="od_hp">핸드폰</label>
                        <input type="text" name="od_hp" value="<?php echo get_text($member['mb_hp']); ?>" id="od_hp"
                               class="frm_input" maxlength="20">
                    </li>
                    <li>
                        <strong>주소</strong>

                        <span class="add_num"><label for="od_zip" class="sound_only">우편번호<strong
                                        class="sound_only"> 필수</strong></label>
                    <input type="text" name="od_zip" value="<?php echo $member['mb_zip1'] . $member['mb_zip2']; ?>"
                           id="od_zip" required class="frm_input required" size="5" maxlength="6">
                    <button type="button" class="btn_frmline btn_addsch"
                            onclick="win_zip('forderform', 'od_zip', 'od_addr1', 'od_addr2', 'od_addr3', 'od_addr_jibeon');">주소검색</button></span>
                        <label for="od_addr1" class="sound_only">기본주소<strong class="sound_only"> 필수</strong></label>
                        <input type="text" name="od_addr1" value="<?php echo get_text($member['mb_addr1']) ?>"
                               id="od_addr1" required class="frm_input frm_address required">
                        <label for="od_addr2" class="sound_only">상세주소</label>
                        <input type="text" name="od_addr2" value="<?php echo get_text($member['mb_addr2']) ?>"
                               id="od_addr2" class="frm_input frm_address">
                        <label for="od_addr3" class="sound_only">참고항목</label>
                        <input type="text" name="od_addr3" value="<?php echo get_text($member['mb_addr3']) ?>"
                               id="od_addr3" class="frm_input frm_address" readonly="readonly">
                        <input type="hidden" name="od_addr_jibeon"
                               value="<?php echo get_text($member['mb_addr_jibeon']); ?>" id='od_addr_jibeon'><br>

                    </li>
                    <li>
                        <label for="od_email">E-mail<strong class="sound_only"> 필수</strong></label>
                        <input type="email" name="od_email" value="<?php echo $member['mb_email']; ?>" id="od_email"
                               required class="frm_input required" maxlength="100">
                    </li>
                    ...
                    <?php if ($default['de_hope_date_use']) { // 배송희망일 사용 ?>
                        ...
                        <?php
                            ...
                            <input type="text" name="od_hope_date" value="" id="od_hope_date" required
                                   class="frm_input required" size="11" maxlength="10" readonly> 이후로 배송 바랍니다.
            ...
            <div class="odf_list">
                <ul>
                    ...
                    <li>
                        ...
                        <input type="text" name="od_b_name" id="od_b_name" required class="frm_input required"
                               maxlength="20">
                    </li>
                    <li>
                        <label for="od_b_tel">전화번호<strong class="sound_only"> 필수</strong></label>
                        <input type="text" name="od_b_tel" id="od_b_tel" required class="frm_input required"
                               maxlength="20">
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <span class="add_num"><input type="text" name="od_b_zip" id="od_b_zip" required
                                                     class="frm_input required" size="5" maxlength="6">
                    <button type="button" class="btn_frmline  btn_addsch"
                            onclick="win_zip('forderform', 'od_b_zip', 'od_b_addr1', 'od_b_addr2', 'od_b_addr3', 'od_b_addr_jibeon');">주소 검색</button></span>
                        ...
                        <input type="text" name="od_b_addr1" id="od_b_addr1" required
                               class="frm_input frm_address required">
                    ...
                    <li>
                        <label for="od_memo">배송 메세지</label>
        ...
        <section id="sod_frm_pay">
            ...
            <div class="odf_tbl">
                <table>
                    ...
                    <tr>
                        <th>추가배송비</th>
                        <td><span id="od_send_cost2_txt">0</span>원<br>
                            (지역에 따라 추가되는 도선료 등의 배송비입니다.)</td>
                    </tr>
                    <tr>
                        <th>총 주문금액</th>
                        <td><span id="od_tot_price"><?php echo number_format($tot_price); ?></span>원</td>
                        <input id="all_money" class="point_input point_input_read" type='hidden'
                               onkeyup='return removeChar(event)' readonly
                               value="<?php echo number_format($tot_price); ?>">
                    </tr>
                    </tbody>
                </table>
            </div>
            <?php
            $info = mysql_fetch_array(mysql_query("select * from g5_member where mb_id = '{$member['mb_id']}'"));
            ?>
            <h2 class="bar_add">보유 포인트</h2>
            <div id="od_have_price">
                <span>VMC</span>
                <div><strong>
                        <input id="vmc_point" class="point_input point_input_read" type='text'
                               value="<?= $info['VMC'] ?>" onkeyup='return removeChar(event)'>
                        <input id="vmc_point_1" type="hidden" value="<?= $info['VMC'] ?>">
                    </strong>원
                </div>
            </div>
            <div id="od_have2_price">
                <span>VMP</span>
                <div><strong>
                        <input id="vmp_point" class="point_input point_input_read" type='text'
                               value="<?= $info['VMP'] ?>" onkeyup='return removeChar(event)'>
                        <input id="vmp_point_1" type="hidden" value="<?= $info['VMP'] ?>">
                    </strong>원
                </div>
            </div>
            <div id="od_have3_price">
                <span>VMM</span>
                <div><strong>
                        <input id="vmm_point" class="point_input point_input_read" type='text'
                               value="<?= $info['VMM'] ?>" onkeyup='return removeChar(event)'>
                        <input id="vmm_point_1" type="hidden" value="<?= $info['VMM'] ?>">
                    </strong>원
                </div>
            </div>
            <div id="od_have4_price">
                <span>VCASH</span>
                <div><strong>
                        <input id="vcash_point" class="point_input point_input_read" type='text'
                               value="<?= $info['VCash'] ?>" onkeyup='return removeChar(event)'>
                        <input id="vcash_point_1" type="hidden" value="<?= $info['VCash'] ?>">
                    </strong>원
                </div>
            </div>
            <div id="od_have5_price">
                <span>VPAY</span>
                <div><strong>
                        <input id="vpay_point" class="point_input point_input_read" type='text'
                               value="<?= $info['VPay'] ?>" onkeyup='return removeChar(event)'>
                        <input id="vpay_point_1" type="hidden" value="<?= $info['VPay'] ?>">
                    </strong>원
                </div>
            </div>
            <h2 class="bar_add">사용하실 포인트</h2>
            <div id="od_point_price">
                <span>VMC</span>
                <div><strong><input id="lend_money" class="point_input" type='text' onkeyup='return removeChar(event)'
                                    onfocusout="return removeChar(event)"></strong>원
                </div>
            </div>
            <div id="od_point2_price">
                <span>VMP</span>
                <div><strong><input id="bite" class="point_input" type='text' onkeyup='return removeChar(event)'
                                    onfocusout="return removeChar(event)"></strong>원
                </div>
            </div>
            <div id="od_point3_price">
                <span>VMM</span>
                <div><strong><input id="vmm_money" class="point_input" type='text' onkeyup='return removeChar(event)'
                                    onfocusout="return removeChar(event)"></strong>원
                </div>
            </div>
            <div id="od_point_price">
                <span>VCASH</span>
                <div><strong><input id="vcash_money" class="point_input" type='text' onkeyup='return removeChar(event)'
                                    onfocusout="return removeChar(event)"></strong>원
                </div>
            </div>
            <div id="od_point_price">
                <span>VPAY</span>
                <div><strong><input id="vpay_money" class="point_input" type='text' onkeyup='return removeChar(event)'
                                    onfocusout="return removeChar(event)"></strong>원
                </div>
            </div>
            <div id="od_last_price">
                <span>최종 결제금액</span>
                <div><strong><input id="sum" class="point_input point_input_read" type='text'
                                    onkeyup='return removeChar(event)' readonly
                                    value="<?php echo number_format($tot_price); ?>"></strong>원
                </div>
            </div>
            ...
            <script>
                ...
                function removeChar(event) {
                    ...
                    //vmp, vmc, vmm, vcash, vpay포인트를 모두 사용할때
                    if (document.getElementById("lend_money").value && document.getElementById("bite").value && document.getElementById("vmm_money").value && document.getElementById("vcash_money").value && document.getElementById("vpay_money").value) {

                        document.getElementById('sum').value = parseInt(document.getElementById("all_money").value.replace(/,/g, "")) - parseInt(document.getElementById('lend_money').value.replace(/,/g, "")) - parseInt(document.getElementById('bite').value.replace(/,/g, "")) - parseInt(document.getElementById('vmm_money').value.replace(/,/g, "")) - parseInt(document.getElementById('vcash_money').value.replace(/,/g, "")) - parseInt(document.getElementById('vpay_money').value.replace(/,/g, ""));

                        if (document.getElementById('sum').value < 0) { //대여금 변제된 값이 0이나 -값이 나오지 않도록 이벤트처리
                            alert('사용하시는 포인트는 제품의 가격보다 클 수 없습니다.');
                            event.stopPropagation();
                            document.getElementById('bite').value = null;
                            document.getElementById('lend_money').value = null;
                            document.getElementById('vmm_money').value = null;
                            document.getElementById('vcash_money').value = null;
                            document.getElementById('vpay_money').value = null;
                            document.getElementById('sum').value = null;
                            return false;
                        }

                        document.getElementById('sum').value = String(document.getElementById('sum').value).replace(/(\d)(?=(?:\d{3})+(?!\d))/g, '$1,');
                        //vmc포인트만 사용할때
                    } else if (document.getElementById("lend_money") == event.target) {

                        pointVal(document.getElementById("lend_money"));

                        //vmp포인트만 사용할때
                    } else if (document.getElementById("bite") == event.target) {

                        pointVal(document.getElementById("bite"));

                        //vmm포인트만 사용할때
                    } else if (document.getElementById("vmm_money") == event.target) {

                        pointVal(document.getElementById("vmm_money"));

                        //vcash 포인트만 사용할때
                    } else if (document.getElementById("vcash_money") == event.target) {

                        pointVal(document.getElementById("vcash_money"));

                        //vpay 포인트만 사용할때
                    } else if (document.getElementById("vpay_money") == event.target) {

                        pointVal(document.getElementById("vpay_money"));

                    }


                    function pointVal(obj) {
                        let temp = 0;

                        if (parseInt(document.getElementById('bite').value.replace(/,/g, "")) > 0) {
                            temp += parseInt(document.getElementById('bite').value.replace(/,/g, ""));
                        }
                        if (parseInt(document.getElementById('lend_money').value.replace(/,/g, "")) > 0) {
                            temp += parseInt(document.getElementById('lend_money').value.replace(/,/g, ""));
                        }
                        if (parseInt(document.getElementById('vmm_money').value.replace(/,/g, "")) > 0) {
                            temp += parseInt(document.getElementById('vmm_money').value.replace(/,/g, ""));
                        }
                        if (parseInt(document.getElementById('vcash_money').value.replace(/,/g, "")) > 0) {
                            temp += parseInt(document.getElementById('vcash_money').value.replace(/,/g, ""));
                        }
                        if (parseInt(document.getElementById('vpay_money').value.replace(/,/g, "")) > 0) {
                            temp += parseInt(document.getElementById('vpay_money').value.replace(/,/g, ""));
                        }


                        document.getElementById('sum').value =
                            String(
                                parseInt(document.getElementById("all_money").value.replace(/,/g, "")
                                )
                                -
                                parseInt(temp)
                            );
                    ...
                    //vmc포인트를 사용할때 가지고 있는 포인트 이상 사용 못하게
                    if (document.getElementById("lend_money").value) {
                        document.getElementById('vmc_point').value = parseInt(document.getElementById("vmc_point_1").value.replace(/,/g, "")) - parseInt(document.getElementById('lend_money').value.replace(/,/g, ""));

                        if (document.getElementById('vmc_point').value < 0) {
                            alert('보유하신 VMC포인트 이상을 입력하였습니다.');
                            event.stopPropagation();
                            document.getElementById('lend_money').value = null;
                            document.getElementById('sum').value = null;
                            document.getElementById("vmc_point").value = document.getElementById("vmc_point_1").value;
                            document.getElementById('vmc_point').value = String(document.getElementById('vmc_point').value).replace(/(\d)(?=(?:\d{3})+(?!\d))/g, '$1,');
                            return false;
                    ...
                    //vmp포인트를 사용할때 가지고 있는 포인트 이상 사용 못하게
                    if (document.getElementById("bite").value) {
                        document.getElementById('vmp_point').value = parseInt(document.getElementById("vmp_point_1").value.replace(/,/g, "")) - parseInt(document.getElementById('bite').value.replace(/,/g, ""));
                        if (document.getElementById('vmp_point').value < 0) { //대여금 변제된 값이 0이나 -값이 나오지 않도록 이벤트처리
                            alert('보유하신 VMP포인트 이상을 입력하였습니다.');
                            event.stopPropagation();
                            document.getElementById('bite').value = null;
                            document.getElementById('sum').value = null;
                            document.getElementById("vmp_point").value = document.getElementById("vmp_point_1").value;
                            document.getElementById('vmp_point').value = String(document.getElementById('vmp_point').value).replace(/(\d)(?=(?:\d{3})+(?!\d))/g, '$1,');
                            return false;
                        }
                    ...
                    //vmp를 안쓸때
                    if ($("#bite").val() == "") { //대여금 변제된 값이 0이나 -값이 나오지 않도록 이벤트처리
                        document.getElementById("vmp_point").value = document.getElementById("vmp_point_1").value;
                        document.getElementById('vmp_point').value = String(document.getElementById('vmp_point').value).replace(/(\d)(?=(?:\d{3})+(?!\d))/g, '$1,');
                    }
                    //vmm포인트를 사용할때 가지고 있는 포인트 이상 사용 못하게
                    if (document.getElementById("vmm_money").value) {
                        document.getElementById('vmm_point').value = parseInt(document.getElementById("vmm_point_1").value.replace(/,/g, "")) - parseInt(document.getElementById('vmm_money').value.replace(/,/g, ""));

                        if (document.getElementById('vmm_point').value < 0) { //대여금 변제된 값이 0이나 -값이 나오지 않도록 이벤트처리
                            alert('보유하신 VMM포인트 이상을 입력하였습니다.');
                            event.stopPropagation();
                            document.getElementById('vmm_money').value = null;
                            document.getElementById('sum').value = null;
                            document.getElementById("vmm_point").value = document.getElementById("vmm_point_1").value;
                            document.getElementById('vmm_point').value = String(document.getElementById('vmm_point').value).replace(/(\d)(?=(?:\d{3})+(?!\d))/g, '$1,');
                            return false;
                    ...
                    //vmm를 안쓸때
                    if ($("#vmm_money").val() == "") { //대여금 변제된 값이 0이나 -값이 나오지 않도록 이벤트처리
                        document.getElementById("vmm_point").value = document.getElementById("vmm_point_1").value;
                        document.getElementById('vmm_point').value = String(document.getElementById('vmm_point').value).replace(/(\d)(?=(?:\d{3})+(?!\d))/g, '$1,');
                    }
                    //vcash 포인트를 사용할때 가지고 있는 포인트 이상 사용 못하게
                    if (document.getElementById("vcash_money").value) {
                        document.getElementById('vcash_point').value = parseInt(document.getElementById("vcash_point_1").value.replace(/,/g, "")) - parseInt(document.getElementById('vcash_money').value.replace(/,/g, ""));

                        if (document.getElementById('vcash_point').value < 0) { //대여금 변제된 값이 0이나 -값이 나오지 않도록 이벤트처리
                            alert('보유하신 VCASH포인트 이상을 입력하였습니다.');
                            event.stopPropagation();
                            document.getElementById('vcash_money').value = null;
                            document.getElementById('sum').value = null;
                            document.getElementById("vcash_point").value = document.getElementById("vcash_point_1").value;
                            document.getElementById('vcash_point').value = String(document.getElementById('vcash_point').value).replace(/(\d)(?=(?:\d{3})+(?!\d))/g, '$1,');
                            return false;
                    ...
                    //vcash를 안쓸때
                    if ($("#vcash_money").val() == "") { //대여금 변제된 값이 0이나 -값이 나오지 않도록 이벤트처리
                        document.getElementById("vcash_point").value = document.getElementById("vcash_point_1").value;
                        document.getElementById('vcash_point').value = String(document.getElementById('vcash_point').value).replace(/(\d)(?=(?:\d{3})+(?!\d))/g, '$1,');
                    }

                    //vpay 포인트를 사용할때 가지고 있는 포인트 이상 사용 못하게
                    if (document.getElementById("vpay_money").value) {
                        document.getElementById('vpay_point').value = parseInt(document.getElementById("vpay_point_1").value.replace(/,/g, "")) - parseInt(document.getElementById('vpay_money').value.replace(/,/g, ""));

                        if (document.getElementById('vpay_point').value < 0) { //대여금 변제된 값이 0이나 -값이 나오지 않도록 이벤트처리
                            alert('보유하신 VPAY포인트 이상을 입력하였습니다.');
                            event.stopPropagation();
                            document.getElementById('vpay_money').value = null;
                            document.getElementById('sum').value = null;
                            document.getElementById("vpay_point").value = document.getElementById("vpay_point_1").value;
                            document.getElementById('vpay_point').value = String(document.getElementById('vpay_point').value).replace(/(\d)(?=(?:\d{3})+(?!\d))/g, '$1,');
                            return false;
                    ...
                    //vpay를 안쓸때
                    if ($("#vpay_money").val() == "") { //대여금 변제된 값이 0이나 -값이 나오지 않도록 이벤트처리
                        document.getElementById("vpay_point").value = document.getElementById("vpay_point_1").value;
                        document.getElementById('vpay_point').value = String(document.getElementById('vpay_point').value).replace(/(\d)(?=(?:\d{3})+(?!\d))/g, '$1,');
                    }
                    ...
                    //3자리마다 콤마 붙기
                    document.getElementById('lend_money').value = String(document.getElementById('lend_money').value).replace(/(\d)(?=(?:\d{3})+(?!\d))/g, '$1,');
                    ...
                    document.getElementById('lend_money').value = String(document.getElementById('lend_money').value).replace(/(\d)(?=(?:\d{3})+(?!\d))/g, '$1,');
                    document.getElementById('bite').value = String(document.getElementById('bite').value).replace(/(\d)(?=(?:\d{3})+(?!\d))/g, '$1,');
                    document.getElementById('vmm_money').value = String(document.getElementById('vmm_money').value).replace(/(\d)(?=(?:\d{3})+(?!\d))/g, '$1,');
                    document.getElementById('vcash_money').value = String(document.getElementById('vcash_money').value).replace(/(\d)(?=(?:\d{3})+(?!\d))/g, '$1,');
                    document.getElementById('vpay_money').value = String(document.getElementById('vpay_money').value).replace(/(\d)(?=(?:\d{3})+(?!\d))/g, '$1,');


                    var a = document.getElementById("lend_money").value.replace(/,/g, "");
                    var b = document.getElementById("bite").value.replace(/,/g, "");
                    var c = document.getElementById("vmm_money").value.replace(/,/g, "");
                    var d = document.getElementById("vcash_money").value.replace(/,/g, "");
                    var e = document.getElementById("vpay_money").value.replace(/,/g, "");
                    ...
                    document.getElementById('vmcF').value = a;
                    document.getElementById('vmpF').value = b;
                    document.getElementById('vmmF').value = c;
                    document.getElementById('vcashF').value = d;
                    document.getElementById('vpayF').value = e;
                    document.getElementById('od_temp_point').value = parseInt(a) + parseInt(b) + parseInt(c) + parseInt(d) + parseInt(e);


//        $('.btn_sumit').click(function(){
//            var downPoint = document.getElementById('sum').value;  
//            var numPoint = downPoint.replace(/[^\d]+/g, '');
//            var lastPrice = Math.sign(numPoint); 
//            if(lastPrice == -1){
//                alert('사용하시는 포인트는 제품의 가격보다 클 수 없습니다.');
//                document.getElementById('sum').value = null;
//
...
//        });
            ...
            echo '<li><input type="radio" id="od_settle_point" name="od_settle_case" value="vmp_point" > <label for="od_settle_point" class="lb_icon bank_icon">포인트결제</label><li>';
            echo '</ul>';
...
<script>
    ...
    $(function () {
        ...
        if ($('#vmmCheck').val() == "false") {
            $('#od_point3_price').css("display", "none");
            $('#od_have3_price').css("display", "none");
        }
    ...
    function calculate_order_price() {
        // 모바일에서 value값이 출력되지않아 #sod_frm의 값으로 출력되게 수정함 19-05-21 이지양
        var sell_price = parseInt($("input[name=od_price]").val());
        var send_cost = parseInt($("#sod_frm input[name=od_send_cost]").val());
        var send_cost2 = parseInt($("#sod_frm input[name=od_send_cost2]").val());
        var send_coupon = parseInt($("#sod_frm input[name=od_send_coupon]").val());
        ...
        //동우추가 0626//////////////////////
        $('#all_money').val(number_format(String(tot_price)));
        $('#od_send_cost2_txt').text(number_format(String(send_cost2)));
        $('#sum').val(number_format(String(tot_price)));
        ////////////////////////////////////////////
        <?php if($temp_point > 0 && $is_member) { ?>
        calculate_temp_point();
        <?php } ?>
    ...
    function pay_approval() {
        ...
        if (jQuery(pf).triggerHandler("form_sumbit_order_" + form_order_method) !== false) {
            ...
            if ($("input[type=radio][name=od_settle_case]:checked").val() == "vmp_point") {
                // VMP 포인트결제일 때 참
                if (document.getElementById("sum").value != "0") {
                    alert("포인트결제는 최종 결제금액이 0원이 되어야 주문할 수 있습니다.");
                    return false;
                }


                document.sm_form.action = "/shop/orderformupdate.php";


                document.getElementById("sm_od_name").value = document.getElementById("od_name").value;
                document.getElementById("sm_od_email").value = document.getElementById("od_email").value;
                document.getElementById("sm_od_tel").value = document.getElementById("od_tel").value;
                document.getElementById("sm_od_hp").value = document.getElementById("od_hp").value;
                document.getElementById("sm_od_zip").value = document.getElementById("od_zip").value;
                document.getElementById("sm_od_zip1").value = document.getElementById("od_zip").value.substring(0, 3);
                document.getElementById("sm_od_zip2").value = document.getElementById("od_zip").value.substring(3, 5);
                document.getElementById("sm_od_addr1").value = document.getElementById("od_addr1").value;
                document.getElementById("sm_od_addr2").value = document.getElementById("od_addr2").value;
                document.getElementById("sm_od_addr3").value = document.getElementById("od_addr3").value;
                document.getElementById("sm_od_addr_jibeon").value = document.getElementById("sm_od_addr_jibeon").value;
                document.getElementById("sm_pd_deposit_name").value = document.getElementById("ad_subject").value;
                document.getElementById("sm_od_b_name").value = document.getElementById("od_b_name").value;
                document.getElementById("sm_od_b_tel").value = document.getElementById("od_b_tel").value;
                document.getElementById("sm_od_b_hp").value = document.getElementById("od_b_hp").value;
                document.getElementById("sm_od_b_zip").value = document.getElementById("od_b_zip").value;
                document.getElementById("sm_od_b_zip1").value = document.getElementById("od_b_zip").value.substring(0, 3);
                document.getElementById("sm_od_b_zip2").value = document.getElementById("od_b_zip").value.substring(3, 5);
                document.getElementById("sm_od_b_addr1").value = document.getElementById("od_b_addr1").value;
                document.getElementById("sm_od_b_addr2").value = document.getElementById("od_b_addr2").value;
                document.getElementById("sm_od_b_addr3").value = document.getElementById("od_b_addr3").value;
                document.getElementById("sm_od_b_addr_jibeon").value = document.getElementById("od_b_addr_jibeon").value;

                /*배송비 전송*/
                f.od_send_cost.value = pf.od_send_cost.value;
                f.od_send_cost2.value = pf.od_send_cost2.value;
                f.od_send_coupon.value = pf.od_send_coupon.value;
                /*배송비 전송*/


                document.getElementById("sm_od_mobile").value = "1";
                ...
                document.getElementById("sm_vmcF").value = a;
                document.getElementById("sm_vmpF").value = b;
                document.getElementById("sm_vmmF").value = c;
                document.getElementById("sm_vcashF").value = d;
                document.getElementById("sm_vpayF").value = e;
                ...
                document.getElementById('sm_od_temp_point').value = parseInt(a) + parseInt(b) + parseInt(c) + parseInt(d) + parseInt(e);

            } else {
                document.sm_form.action = "/mobile/shop/kcp/order_approval_form.php";
            }
            f.submit();
        }
